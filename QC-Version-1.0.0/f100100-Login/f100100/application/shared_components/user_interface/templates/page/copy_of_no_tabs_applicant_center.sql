...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98554590904128407)
,p_theme_id=>42
,p_name=>'Copy of Copy of No Tabs Applicant Center'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98555023851128408)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98555581537128408)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98556013747128408)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98556521148128408)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98557016091128408)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98557546180128409)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98558001354128409)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98558533798128409)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98559091054128409)
,p_page_template_id=>wwv_flow_api.id(98554590904128407)
