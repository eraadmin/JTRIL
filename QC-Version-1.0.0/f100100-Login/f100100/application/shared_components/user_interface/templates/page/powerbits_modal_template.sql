prompt --application/shared_components/user_interface/templates/page/powerbits_modal_template
begin
--   Manifest
--     TEMPLATE: POWERBITS_MODAL_TEMPLATE
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98606268528128451)
,p_theme_id=>42
,p_name=>'Copy of PowerBits Modal Template'
,p_internal_name=>'POWERBITS_MODAL_TEMPLATE'
,p_is_popup=>true
...
'    background-color: linear-gradient(to left, &PAG_BODY_BGCLRL., &PAG_BODY_BGCLRR.);',
...
'',
'/* ---------------------Item Container Input Field CSS Start New Requirment --------------*/',
'',
...
'    padding: calc(var(--a-field-input-padding-y) - var(--a-field-input-border-width)) calc(var(--a-field-input-padding-x) - var(--a-field-input-border-width));',
'    font-size: var(--a-field-input-font-size);',
'    line-height: var(--a-field-input-line-height);',
'    font-weight: var(--a-field-input-font-weight);',
'    background-color: white;',
'    color: var(--a-field-input-text-color);',
'    border-radius: var(--a-field-input-border-radius);',
'    /*border-bottom: 1px solid black; */',
'    box-shadow: var(--a-field-input-shadow);',
'}',
'',
'',
'.apex-item-multi, .apex-item-text.a-PopupLOV-search, .apex-item-text.apex-item-popup-lov {',
...
'    border-radius: var(--a-field-input-border-radius);',
'    /*border-bottom: 1px solid black; */',
'    /* border-width: var(--a-field-input-border-width); */',
'    /* border-style: solid; */',
'    box-shadow: var(--a-field-input-shadow);',
'}',
'',
...
'    z-index: 1000;',
'    border-width: 0;',
'    box-shadow: 0 0 0 0.1rem rgb(0 0 0 / 10%) inset, 0 3px 9px -2px rgb(0 0 0 / 10%);',
'}',
'',
'/* ---------------- Success Alert Css Close --------------------*/'))
,p_header_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<!DOCTYPE html>',
'<html class="no-js #RTL_CLASS# page-&APP_PAGE_ID. app-&APP_ALIAS." lang="&BROWSER_LANGUAGE." #TEXT_DIRECTION#>',
'<script src="http://ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script> <!--- Added by Template team------>',
'<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script> <!--- Added by Template team------>',
'<head>',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98606755570128453)
,p_page_template_id=>wwv_flow_api.id(98606268528128451)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98607224416128454)
,p_page_template_id=>wwv_flow_api.id(98606268528128451)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98607706283128454)
,p_page_template_id=>wwv_flow_api.id(98606268528128451)
