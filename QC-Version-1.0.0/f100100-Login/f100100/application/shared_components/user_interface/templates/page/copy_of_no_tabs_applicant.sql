...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98549737365128373)
,p_theme_id=>42
,p_name=>'Copy of Copy of No Tabs Applicant'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98550259796128404)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98550681902128404)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98551124808128405)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98551630519128405)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98552185435128406)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98552664099128406)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98553110301128407)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98553635858128407)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98554136789128407)
,p_page_template_id=>wwv_flow_api.id(98549737365128373)
