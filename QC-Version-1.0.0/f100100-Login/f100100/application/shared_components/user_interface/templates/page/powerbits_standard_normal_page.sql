prompt --application/shared_components/user_interface/templates/page/powerbits_standard_normal_page
begin
--   Manifest
--     TEMPLATE: POWERBITS_STANDARD_NORMAL_PAGE
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(100157537431764838)
,p_theme_id=>42
,p_name=>'PowerBits Standard Normal Page'
,p_internal_name=>'POWERBITS_STANDARD_NORMAL_PAGE'
,p_is_popup=>false
...
'  #REGION_POSITION_07#',
'  <div class="t-Header-branding" style="height:40px;">',
...
'     		<a href="#HOME_LINK#" class="t-Header-logo-link" style="max-height: 6rem;">',
'				<b><img src=/i/powerbits_logo_s.png  alt="PowerBits ERP" height="30px" width="auto"></b>',
'				    </a> ',
'',
'<div style="text-align:right; height:10px; position:absolute; top: 8px; left: 90%; font-size:12px;color:white; font-weight:bold;">',
'        <a  href="&LOGOUT_URL." >',
'			<font color=''white''>Logout : <b style="color:&PAG_HDR_BGCLRL.;font-weight:bold;" >&APP_USER.</b></font></a>',
'            <br>',
'            <!--<a href="f?p=&APP_ID.:82:&SESSION."> </a>-->',
'        </div>',
'   <!-- <div style="text-align:center; height:20px; position:absolute;position: absolute; top: 10px;left: 50%; margin-left: -160px;font-size:16px; font-weight:bold;color:white;">&P1_COMPNAME.',
'        <br><font size=''2'' color=''white''>&P1_COMPADD.</font> -->',
'  </div>',
...
'        <div class="t-Body-contentInner" style="margin-left:5px;">',
'          #BODY#',
'        </div>',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100157969271764838)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100158433236764838)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100159011193764840)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100159516703764840)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100159931806764840)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100160498905764840)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
,p_name=>'Page Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(100160972391764840)
,p_page_template_id=>wwv_flow_api.id(100157537431764838)
