prompt --application/shared_components/user_interface/templates/page/copy_of_login
begin
--   Manifest
--     TEMPLATE: COPY_OF_LOGIN
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98544903844128331)
,p_theme_id=>42
,p_name=>'Copy of Copy of Login'
,p_internal_name=>'COPY_OF_LOGIN'
,p_is_popup=>false
...
'</table>',
'',
'<div style="font-weight:bold; text-align:center; color:#FF0000">#GLOBAL_NOTIFICATION##SUCCESS_MESSAGE##NOTIFICATION_MESSAGE#</div>',
'',
'<div style="width:130px;margin-left:30px" id="t14BreadCrumbsRight" >#REGION_POSITION_01#<img src="#IMAGE_PREFIX#themes/theme_14/1px_trans.gif" width="1" height="1" alt="" /></div>',
'',
'<table align="center" border="0" cellpadding="0" cellspacing="0" summary=""  class="t14Login">',
'<tr>',
'<td>#REGION_POSITION_02#</td>',
'<td>#REGION_POSITION_03#</td>',
'</tr>',
'',
'<tr>',
'<td>#BODY##REGION_POSITION_04##REGION_POSITION_05##REGION_POSITION_06##REGION_POSITION_07##REGION_POSITION_08#</td>',
'</tr>',
'</table>',
'',
'<table border="0" cellpadding="0" cellspacing="0" summary="" height="30%" width="100%" >',
'<tr><td width="100%"></td></tr>',
'</table>'))
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98545332267128355)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98545815470128360)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98546342590128360)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98546839151128360)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98547330522128361)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98547890174128361)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98548369621128361)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98548824112128361)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98549355060128361)
,p_page_template_id=>wwv_flow_api.id(98544903844128331)
