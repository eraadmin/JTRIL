...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98568784337128418)
,p_theme_id=>42
,p_name=>'Copy of Copy of Public'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98569203383128418)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98569790711128418)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98570261647128418)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98570756866128419)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98571237526128419)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98571749804128420)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98572223458128420)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98572702180128420)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98573260976128421)
,p_page_template_id=>wwv_flow_api.id(98568784337128418)
