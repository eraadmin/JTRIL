prompt --application/shared_components/user_interface/templates/page/copy_of_printer_friendly
begin
--   Manifest
--     TEMPLATE: COPY_OF_PRINTER_FRIENDLY
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98564327356128416)
,p_theme_id=>42
,p_name=>'Copy of Copy of Printer Friendly'
,p_internal_name=>'COPY_OF_PRINTER_FRIENDLY'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98564809379128416)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98565335740128416)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98565845362128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98566393877128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98566821597128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98567343116128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98567816545128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98568378335128417)
,p_page_template_id=>wwv_flow_api.id(98564327356128416)
