prompt --application/shared_components/user_interface/templates/page/copy_of_register
begin
--   Manifest
--     TEMPLATE: COPY_OF_REGISTER
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98573617795128421)
,p_theme_id=>42
,p_name=>'Copy of Copy of Register'
,p_internal_name=>'COPY_OF_REGISTER'
,p_is_popup=>false
...
'<tr>',
'<td id="t14Logo" valign="top"><a href="f?p=100:1:&SESSION.">#LOGO#</a><br />#REGION_POSITION_06#</td>',
...
'  </table>',
'</td>',
'<td id="t14NavBar" valign="top"> Welcome <span style="color:#2A5C9B"> New Applicant</span> ',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98574187348128421)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98574671729128422)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98575109050128422)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98575605193128422)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98576186488128423)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98576689861128423)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98577194136128423)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98577607106128424)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98578190946128424)
,p_page_template_id=>wwv_flow_api.id(98573617795128421)
