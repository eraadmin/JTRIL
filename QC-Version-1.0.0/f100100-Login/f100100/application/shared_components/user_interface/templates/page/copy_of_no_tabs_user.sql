prompt --application/shared_components/user_interface/templates/page/copy_of_no_tabs_user
begin
--   Manifest
--     TEMPLATE: COPY_OF_NO_TABS_USER
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98559489662128412)
,p_theme_id=>42
,p_name=>'Copy of Copy of No Tabs User'
,p_internal_name=>'COPY_OF_NO_TABS_USER'
,p_is_popup=>false
...
'<tr>',
'<td id="t14Logo" valign="top"><a href="f?p=100:7:&SESSION.">#LOGO#</a><br />#REGION_POSITION_06#</td>',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98559922616128413)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98560480211128414)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98560940181128414)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98561407386128414)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98561965128128415)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98562496633128415)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98562943785128415)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98563495731128415)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98563923930128416)
,p_page_template_id=>wwv_flow_api.id(98559489662128412)
