...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(98593621196128433)
,p_theme_id=>42
,p_name=>'Copy of Master Detail'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98594125794128434)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98594674866128435)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98595172489128435)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98595610669128437)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98596127453128437)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98596648748128437)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98597119024128437)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98597648967128439)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
,p_name=>'Page Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(98598187829128439)
,p_page_template_id=>wwv_flow_api.id(98593621196128433)
