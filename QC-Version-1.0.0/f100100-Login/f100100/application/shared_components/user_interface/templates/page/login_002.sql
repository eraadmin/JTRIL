...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(99942593400690137)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(99942832597690138)
,p_page_template_id=>wwv_flow_api.id(99942593400690137)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(99943203481690138)
,p_page_template_id=>wwv_flow_api.id(99942593400690137)
,p_name=>'Body Header'
