prompt --application/shared_components/user_interface/lovs/zone_list
begin
--   Manifest
--     ZONE LIST
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(31965128710135491)
,p_lov_name=>'ZONE LIST'
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(31965537048135491)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(31965927803135491)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(31966395302135491)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(31966703022135491)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(31967115155135492)
