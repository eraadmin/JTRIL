prompt --application/shared_components/user_interface/lovs/salesman_list1
begin
--   Manifest
--     SALESMAN LIST1
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(32013349350211105)
,p_lov_name=>'SALESMAN LIST1'
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(32013735999211105)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(32014117381211105)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(32014535766211105)
...
wwv_flow_api.create_list_of_values_cols(
 p_id=>wwv_flow_api.id(32014982119211106)
