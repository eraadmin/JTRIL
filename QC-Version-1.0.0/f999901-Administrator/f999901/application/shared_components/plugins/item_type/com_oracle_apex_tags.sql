...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(16092035438760362733)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2273838188622677548)
,p_plugin_id=>wwv_flow_api.id(16092035438760362733)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2273838579812677548)
,p_plugin_attribute_id=>wwv_flow_api.id(2273838188622677548)
,p_display_sequence=>10
,p_display_value=>'None'
,p_return_value=>'NONE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2273839100885677548)
,p_plugin_attribute_id=>wwv_flow_api.id(2273838188622677548)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2273839581654677549)
,p_plugin_attribute_id=>wwv_flow_api.id(2273838188622677548)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2273840039478677549)
,p_plugin_id=>wwv_flow_api.id(16092035438760362733)
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(847178268452770416)
,p_plugin_id=>wwv_flow_api.id(16092035438760362733)
,p_name=>'LOV'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2273841288677677550)
,p_plugin_id=>wwv_flow_api.id(16092035438760362733)
