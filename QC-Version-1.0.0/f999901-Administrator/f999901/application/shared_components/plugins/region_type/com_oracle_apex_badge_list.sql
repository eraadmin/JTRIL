...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(2048956746252583078)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018454378745760115)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018454719988760115)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018455179521760115)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(1018462681445760120)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018455531063760115)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018455960982760116)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018456838015760116)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018457314866760117)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018457859441760117)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018458314223760117)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018458872102760118)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018459299481760118)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018456389123760116)
,p_plugin_attribute_id=>wwv_flow_api.id(1018455960982760116)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018459754066760118)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018460186926760118)
,p_plugin_attribute_id=>wwv_flow_api.id(1018459754066760118)
,p_display_sequence=>0
,p_display_value=>'Small'
,p_return_value=>'S'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018460629249760119)
,p_plugin_attribute_id=>wwv_flow_api.id(1018459754066760118)
,p_display_sequence=>10
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018461114779760119)
,p_plugin_attribute_id=>wwv_flow_api.id(1018459754066760118)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018461624516760119)
,p_plugin_attribute_id=>wwv_flow_api.id(1018459754066760118)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018462139600760120)
,p_plugin_attribute_id=>wwv_flow_api.id(1018459754066760118)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018462681445760120)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018463014715760120)
,p_plugin_attribute_id=>wwv_flow_api.id(1018462681445760120)
,p_display_sequence=>10
,p_display_value=>'Default'
,p_return_value=>'BOX'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018464052134760121)
,p_plugin_attribute_id=>wwv_flow_api.id(1018462681445760120)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018463582379760121)
,p_plugin_attribute_id=>wwv_flow_api.id(1018462681445760120)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018464558155760121)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018464910783760121)
,p_plugin_attribute_id=>wwv_flow_api.id(1018464558155760121)
,p_display_sequence=>10
,p_display_value=>'Yes'
,p_return_value=>'Y'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(1018465431744760122)
,p_plugin_attribute_id=>wwv_flow_api.id(1018464558155760121)
,p_display_sequence=>20
,p_display_value=>'No'
,p_return_value=>'N'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(1018465940364760122)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(1018467832826760124)
,p_plugin_id=>wwv_flow_api.id(2048956746252583078)
,p_name=>'SOURCE_SQL'
