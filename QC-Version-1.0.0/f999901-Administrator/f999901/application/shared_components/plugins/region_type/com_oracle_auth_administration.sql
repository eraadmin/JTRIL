...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1582608878138993685)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2446390674391994072)
,p_plugin_id=>wwv_flow_api.id(1582608878138993685)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2446391074994994072)
,p_plugin_id=>wwv_flow_api.id(1582608878138993685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2446391477912994072)
,p_plugin_id=>wwv_flow_api.id(1582608878138993685)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2446391885084994072)
,p_plugin_id=>wwv_flow_api.id(1582608878138993685)
,p_attribute_scope=>'COMPONENT'
