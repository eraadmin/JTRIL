...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1434345412905541997)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2289514933968894371)
,p_plugin_id=>wwv_flow_api.id(1434345412905541997)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2289515403144894372)
,p_plugin_id=>wwv_flow_api.id(1434345412905541997)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(847177400219770399)
,p_plugin_id=>wwv_flow_api.id(1434345412905541997)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2289516663133894374)
,p_plugin_id=>wwv_flow_api.id(1434345412905541997)
