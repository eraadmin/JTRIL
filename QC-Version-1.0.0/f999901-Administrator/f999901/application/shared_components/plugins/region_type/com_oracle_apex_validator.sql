...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(1510048713261641724)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(589355729407777418)
,p_plugin_id=>wwv_flow_api.id(1510048713261641724)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(589356189625777419)
,p_plugin_id=>wwv_flow_api.id(1510048713261641724)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(847177502541770401)
,p_plugin_id=>wwv_flow_api.id(1510048713261641724)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(589357189388777420)
,p_plugin_id=>wwv_flow_api.id(1510048713261641724)
