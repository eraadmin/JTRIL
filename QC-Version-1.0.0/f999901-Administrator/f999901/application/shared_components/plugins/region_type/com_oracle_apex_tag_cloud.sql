...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(7406217586247074995)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2323157344746035521)
,p_plugin_id=>wwv_flow_api.id(7406217586247074995)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2323157760463035521)
,p_plugin_id=>wwv_flow_api.id(7406217586247074995)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2323158125602035521)
,p_plugin_id=>wwv_flow_api.id(7406217586247074995)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(847178109029770414)
,p_plugin_id=>wwv_flow_api.id(7406217586247074995)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2323159429939035530)
,p_plugin_id=>wwv_flow_api.id(7406217586247074995)
