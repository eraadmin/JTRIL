...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(2336246738541850)
...
,p_reference_id=>165544877130055643
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2336393600541854)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2336794429541854)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2337199852541854)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2337627222541856)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2338005964541856)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2338419214541856)
,p_plugin_attribute_id=>wwv_flow_api.id(2338005964541856)
,p_display_sequence=>10
,p_display_value=>'1'
,p_return_value=>'1'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2338938756541856)
,p_plugin_attribute_id=>wwv_flow_api.id(2338005964541856)
,p_display_sequence=>20
,p_display_value=>'2'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2339391633541856)
,p_plugin_attribute_id=>wwv_flow_api.id(2338005964541856)
,p_display_sequence=>30
,p_display_value=>'3'
,p_return_value=>'3'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2339928875541856)
,p_plugin_attribute_id=>wwv_flow_api.id(2338005964541856)
,p_display_sequence=>40
,p_display_value=>'4'
,p_return_value=>'4'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(2340376074541859)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2340747896541861)
,p_plugin_attribute_id=>wwv_flow_api.id(2340376074541859)
,p_display_sequence=>10
,p_display_value=>'Big'
,p_return_value=>'B'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(2341301528541861)
,p_plugin_attribute_id=>wwv_flow_api.id(2340376074541859)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(2342064836541868)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(2342543564541873)
,p_plugin_id=>wwv_flow_api.id(2336246738541850)
