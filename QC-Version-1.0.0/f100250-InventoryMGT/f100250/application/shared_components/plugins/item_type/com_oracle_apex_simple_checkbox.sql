...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(67192968237101614)
...
,p_reference_id=>25506444420119873847
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67193232813101615)
,p_plugin_id=>wwv_flow_api.id(67192968237101614)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67193628336101617)
,p_plugin_id=>wwv_flow_api.id(67192968237101614)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67194016821101617)
,p_plugin_id=>wwv_flow_api.id(67192968237101614)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(67194388763101618)
,p_plugin_id=>wwv_flow_api.id(67192968237101614)
