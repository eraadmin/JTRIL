...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(9710480030567181344)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(644548271496372132)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(644548664308372132)
,p_plugin_attribute_id=>wwv_flow_api.id(644548271496372132)
,p_display_sequence=>1
,p_display_value=>'Percentage with relative bar width'
,p_return_value=>'PERCENTAGE_RELATIVE'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(644549148419372133)
,p_plugin_attribute_id=>wwv_flow_api.id(644548271496372132)
,p_display_sequence=>1
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(644549644665372133)
,p_plugin_attribute_id=>wwv_flow_api.id(644548271496372132)
,p_display_sequence=>1
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(644550175127372134)
,p_plugin_attribute_id=>wwv_flow_api.id(644548271496372132)
,p_display_sequence=>1
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(644550675586372135)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_api.id(644548271496372132)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(644551050686372135)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(644551451451372136)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(644551874784372136)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(37400635866517275)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(644553364794372138)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(644553767018372138)
,p_plugin_id=>wwv_flow_api.id(9710480030567181344)
