...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(67198663938101642)
...
,p_reference_id=>1613305814881590434
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67198964417101651)
,p_plugin_id=>wwv_flow_api.id(67198663938101642)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67199310008101657)
,p_plugin_id=>wwv_flow_api.id(67198663938101642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67199684870101662)
,p_plugin_id=>wwv_flow_api.id(67198663938101642)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(67200096509101662)
,p_plugin_id=>wwv_flow_api.id(67198663938101642)
,p_attribute_scope=>'COMPONENT'
