prompt --application/shared_components/plugins/region_type/com_oracle_apex_minicalendar2
begin
--   Manifest
--     PLUGIN: COM.ORACLE.APEX.MINICALENDAR2
--   Manifest End
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(81636496531521157)
,p_plugin_type=>'REGION TYPE'
,p_name=>'COM.ORACLE.APEX.MINICALENDAR2'
,p_display_name=>'Mini-Calendar v.2'
,p_supported_ui_types=>'DESKTOP'
,p_supported_component_types=>'APEX_APPLICATION_PAGE_ITEMS'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('REGION TYPE','COM.ORACLE.APEX.MINICALENDAR2'),'')
...
'    sys.htp.prn(''<table class="apex-mini-calendar">'');',
'    sys.htp.prn(''<caption>''||to_char(l_date, ''Month'')||'' ''||to_char(l_date,''YYYY'')||''</caption>'');',
'    sys.htp.prn(''<thead>'');',
'    sys.htp.prn(''<tr>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_SUN" title="Sunday">Su</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_MON" title="Monday">Mo</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_TUE" title="Tuesday">Tu</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_WED" title="Wednesday">We</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_THU" title="Thursday">Th</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_FRI" title="Friday">Fr</th>'');',
'    sys.htp.prn(''<th scope="col" id="''||l_id||''_SAT" title="Saturday">Sa</th>'');',
'    sys.htp.prn(''</tr>'');',
'    sys.htp.prn(''</thead>'');',
...
'                l_disp := ''<span title="''||l_label||''">''||l_disp||''</span>'';',
'            end if;',
'        end if;',
'        if to_char(l_startdate+l_daycount,''D'') = ''1'' then',
'            sys.htp.prn(''<tr>'');',
'        end if;',
'        sys.htp.prn(''<td class="''||l_class||''" headers="''||l_id||''_''||to_char(l_startdate+l_daycount,''DY'')||''">''||l_disp||''</td>'');',
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(81636717508521165)
,p_plugin_id=>wwv_flow_api.id(81636496531521157)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(81637134983521170)
,p_plugin_id=>wwv_flow_api.id(81636496531521157)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(37400204894517275)
,p_plugin_id=>wwv_flow_api.id(81636496531521157)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(81637495365521173)
,p_plugin_id=>wwv_flow_api.id(81636496531521157)
