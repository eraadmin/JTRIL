...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(81855292064178441)
...
,p_reference_id=>913098112143580081
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(81855637581178441)
,p_plugin_id=>wwv_flow_api.id(81855292064178441)
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(37400032682517275)
,p_plugin_id=>wwv_flow_api.id(81855292064178441)
,p_name=>'SOURCE_SQL'
,p_is_required=>false
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(81856339542178442)
,p_plugin_id=>wwv_flow_api.id(81855292064178441)
