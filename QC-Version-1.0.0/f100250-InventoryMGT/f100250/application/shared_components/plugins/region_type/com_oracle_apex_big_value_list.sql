...
begin
--   Manifest
--     PLUGIN: COM.ORACLE.APEX.BIG_VALUE_LIST
--   Manifest End
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(95623888511661464)
...
,p_reference_id=>664278287058623386
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95624193219661471)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95624616647661473)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95625008729661473)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95625457316661473)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95625864642661473)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95626197010661473)
,p_plugin_attribute_id=>wwv_flow_api.id(95625864642661473)
,p_display_sequence=>10
,p_display_value=>'1'
,p_return_value=>'1'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95626712128661473)
,p_plugin_attribute_id=>wwv_flow_api.id(95625864642661473)
,p_display_sequence=>20
,p_display_value=>'2'
,p_return_value=>'2'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95627256328661478)
,p_plugin_attribute_id=>wwv_flow_api.id(95625864642661473)
,p_display_sequence=>30
,p_display_value=>'3'
,p_return_value=>'3'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95627737908661478)
,p_plugin_attribute_id=>wwv_flow_api.id(95625864642661473)
,p_display_sequence=>40
,p_display_value=>'4'
,p_return_value=>'4'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(95628204937661479)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95628659064661481)
,p_plugin_attribute_id=>wwv_flow_api.id(95628204937661479)
,p_display_sequence=>10
,p_display_value=>'Big'
,p_return_value=>'B'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(95629077242661481)
,p_plugin_attribute_id=>wwv_flow_api.id(95628204937661479)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_std_attribute(
 p_id=>wwv_flow_api.id(37400825045517275)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
,p_name=>'SOURCE_SQL'
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(95630543405661492)
,p_plugin_id=>wwv_flow_api.id(95623888511661464)
