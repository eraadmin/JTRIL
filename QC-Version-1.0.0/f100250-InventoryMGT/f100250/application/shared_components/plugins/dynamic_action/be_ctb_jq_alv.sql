...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(73077493461938132)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73085603074959819)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73097878963962345)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
,p_display_sequence=>10
,p_display_value=>'Required'
,p_return_value=>'notEmpty'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73102186582964498)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73106492815966429)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73110797317967680)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73115101473968820)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73119406321970241)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73156179918981565)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73160494463985750)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73164797926986723)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73169104506988654)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(46251711401325462)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
,p_display_sequence=>110
,p_display_value=>'Select List'
,p_return_value=>'noEmpty'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(46256547378390213)
,p_plugin_attribute_id=>wwv_flow_api.id(73085603074959819)
,p_display_sequence=>120
,p_display_value=>'Select List1'
,p_return_value=>'notEmpty'
);
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73181301568025671)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_api.id(73085603074959819)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73185705723026869)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>10
,p_display_value=>'Number'
,p_return_value=>'number'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73189976072027806)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73194278842028528)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73198580920029227)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73202883691029964)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73207186115030668)
,p_plugin_attribute_id=>wwv_flow_api.id(73181301568025671)
,p_display_sequence=>60
,p_display_value=>'URL'
,p_return_value=>'url'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73219387631040529)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73227683260048780)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73232086723049760)
,p_plugin_attribute_id=>wwv_flow_api.id(73227683260048780)
,p_display_sequence=>10
,p_display_value=>'Blur'
,p_return_value=>'blur'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73236391225051093)
,p_plugin_attribute_id=>wwv_flow_api.id(73227683260048780)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73240697112052762)
,p_plugin_attribute_id=>wwv_flow_api.id(73227683260048780)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73244999883053612)
,p_plugin_attribute_id=>wwv_flow_api.id(73227683260048780)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73257193434061175)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73265495428080657)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73285486901087654)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73293808372093935)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73298193958099189)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73318200547176800)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73322595137184790)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73330885225191356)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73339206350197421)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73347488473201846)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(73351905788206724)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73356279254208582)
,p_plugin_attribute_id=>wwv_flow_api.id(73351905788206724)
,p_display_sequence=>10
,p_display_value=>'After Item'
,p_return_value=>'after'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(73360585141210316)
,p_plugin_attribute_id=>wwv_flow_api.id(73351905788206724)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(68815750543388192)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_name=>'alvformfail'
,p_display_name=>'Form Failure'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(68811440500385301)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_name=>'alvformsuccess'
,p_display_name=>'Form Success'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(68807266342383311)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
,p_name=>'alvitemfail'
,p_display_name=>'Item Failure'
);
wwv_flow_api.create_plugin_event(
 p_id=>wwv_flow_api.id(68803060455381649)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(58085645749184250)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(75239555872448354)
,p_plugin_id=>wwv_flow_api.id(73077493461938132)
