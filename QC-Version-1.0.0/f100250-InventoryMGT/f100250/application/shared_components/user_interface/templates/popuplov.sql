...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(47631430157858371)
,p_page_name=>'winlov'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(51091470210369505)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(61374822546315729)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(1029439585285972140)
...
'#THEME_STYLE_CSS#',
'#APEX_JAVASCRIPT#',
'<link rel="shortcut icon" href="#IMAGE_PREFIX#favicon.ico" type="image/x-icon">  <link rel="stylesheet" href="#IMAGE_PREFIX#themes/theme_25/css/4_2.css" type="text/css" media="all"/>',
'',
'</head>'))
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(1032968598256990493)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(1733916040552258393)
,p_popup_icon=>'#IMAGE_PREFIX#list.gif'
,p_popup_icon_attr=>'width=13 height=13 alt="#LIST_OF_VALUES#" title="#LIST_OF_VALUES#"'
,p_page_name=>'winlov'
,p_page_title=>'Search Dialog'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(10351837412662450783)
,p_popup_icon=>'#IMAGE_PREFIX#f_spacer.gif'
,p_popup_icon_attr=>'alt="#LIST_OF_VALUES#" title="#LIST_OF_VALUES#" class="uPopupLOVIcon"'
,p_page_name=>'winlov'
,p_page_title=>'Search Dialog'
...
'<link rel="shortcut icon" href="#IMAGE_PREFIX#favicon.ico" type="image/x-icon">  <link rel="stylesheet" href="#IMAGE_PREFIX#themes/apps/css/4_1.css" type="text/css" media="all"/>',
'',
'</head>'))
,p_page_body_attr=>'class="uPopUpLOV"'
,p_before_field_text=>'<div class="uActionBar">'
