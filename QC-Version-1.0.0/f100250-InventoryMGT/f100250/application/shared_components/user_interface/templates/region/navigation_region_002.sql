...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(61360725668315713)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2075203942396085)
,p_plug_template_id=>wwv_flow_api.id(61360725668315713)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2075334343396085)
,p_plug_template_id=>wwv_flow_api.id(61360725668315713)
,p_name=>'Sub Regions'
