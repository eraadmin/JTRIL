...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032965677046990491)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147330507396090)
,p_plug_template_id=>wwv_flow_api.id(1032965677046990491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147486495396090)
,p_plug_template_id=>wwv_flow_api.id(1032965677046990491)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147550220396090)
,p_plug_template_id=>wwv_flow_api.id(1032965677046990491)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
