...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032964493129990491)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155387737396090)
,p_plug_template_id=>wwv_flow_api.id(1032964493129990491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155407667396090)
,p_plug_template_id=>wwv_flow_api.id(1032964493129990491)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155555679396090)
,p_plug_template_id=>wwv_flow_api.id(1032964493129990491)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155695296396090)
,p_plug_template_id=>wwv_flow_api.id(1032964493129990491)
,p_name=>'Previous'
