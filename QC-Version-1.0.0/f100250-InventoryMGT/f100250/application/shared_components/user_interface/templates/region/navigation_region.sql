...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(51077781332369478)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2140323915396089)
,p_plug_template_id=>wwv_flow_api.id(51077781332369478)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2140457264396089)
,p_plug_template_id=>wwv_flow_api.id(51077781332369478)
,p_name=>'Sub Regions'
