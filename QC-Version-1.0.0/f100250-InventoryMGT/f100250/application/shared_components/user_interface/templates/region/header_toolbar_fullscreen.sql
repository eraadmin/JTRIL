...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032964776882990491)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2154988294396090)
,p_plug_template_id=>wwv_flow_api.id(1032964776882990491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155015930396090)
,p_plug_template_id=>wwv_flow_api.id(1032964776882990491)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155129647396090)
,p_plug_template_id=>wwv_flow_api.id(1032964776882990491)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155252531396090)
,p_plug_template_id=>wwv_flow_api.id(1032964776882990491)
,p_name=>'Previous'
