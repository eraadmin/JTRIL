...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(2498090607746293244)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2123870221396089)
,p_plug_template_id=>wwv_flow_api.id(2498090607746293244)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2123901529396089)
,p_plug_template_id=>wwv_flow_api.id(2498090607746293244)
,p_name=>'Sub Regions'
