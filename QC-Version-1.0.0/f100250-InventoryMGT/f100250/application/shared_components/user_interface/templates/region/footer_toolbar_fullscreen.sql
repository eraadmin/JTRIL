...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032964201462990490)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155777928396090)
,p_plug_template_id=>wwv_flow_api.id(1032964201462990490)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155833775396090)
,p_plug_template_id=>wwv_flow_api.id(1032964201462990490)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2155997069396090)
,p_plug_template_id=>wwv_flow_api.id(1032964201462990490)
,p_name=>'Change'
