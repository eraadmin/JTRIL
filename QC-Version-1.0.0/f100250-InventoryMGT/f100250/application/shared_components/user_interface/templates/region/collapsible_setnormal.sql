...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032961778095990488)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2157634763396090)
,p_plug_template_id=>wwv_flow_api.id(1032961778095990488)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2157720792396090)
,p_plug_template_id=>wwv_flow_api.id(1032961778095990488)
,p_name=>'Sub Regions'
