...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032965375182990491)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147681760396090)
,p_plug_template_id=>wwv_flow_api.id(1032965375182990491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147772695396090)
,p_plug_template_id=>wwv_flow_api.id(1032965375182990491)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2147884866396090)
,p_plug_template_id=>wwv_flow_api.id(1032965375182990491)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
