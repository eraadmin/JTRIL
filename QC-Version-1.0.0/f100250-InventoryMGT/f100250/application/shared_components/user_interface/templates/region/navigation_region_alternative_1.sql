...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(51078074203369478)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2140158477396089)
,p_plug_template_id=>wwv_flow_api.id(51078074203369478)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2140270071396089)
,p_plug_template_id=>wwv_flow_api.id(51078074203369478)
,p_name=>'Sub Regions'
