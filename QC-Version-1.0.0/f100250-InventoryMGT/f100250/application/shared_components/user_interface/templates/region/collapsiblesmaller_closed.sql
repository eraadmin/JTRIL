...
begin
--   Manifest
--     REGION TEMPLATE: COLLAPSIBLESMALLER_CLOSED
--   Manifest End
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(1032962979187990490)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2156818719396090)
,p_plug_template_id=>wwv_flow_api.id(1032962979187990490)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(2156964263396090)
,p_plug_template_id=>wwv_flow_api.id(1032962979187990490)
,p_name=>'Sub Regions'
