...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029382195451972102)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1056831951395871)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029382595001972102)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029382976263972102)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029383396064972102)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029383793523972102)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029384182897972103)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029384594068972103)
,p_page_template_id=>wwv_flow_api.id(1029382195451972102)
,p_name=>'Right Column'
