...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(47561185048858115)
,p_theme_id=>111
,p_name=>'Modal Dialog'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47561507975858115)
,p_page_template_id=>wwv_flow_api.id(47561185048858115)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47561818547858115)
,p_page_template_id=>wwv_flow_api.id(47561185048858115)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(47562147573858115)
,p_page_template_id=>wwv_flow_api.id(47561185048858115)
