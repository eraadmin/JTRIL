...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029410688547972119)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029411069999972120)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029411471877972120)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029411869620972120)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029412294657972120)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029412697059972120)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029413098812972122)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029413471450972122)
,p_page_template_id=>wwv_flow_api.id(1029410688547972119)
,p_name=>'Icon Nav Bar'
