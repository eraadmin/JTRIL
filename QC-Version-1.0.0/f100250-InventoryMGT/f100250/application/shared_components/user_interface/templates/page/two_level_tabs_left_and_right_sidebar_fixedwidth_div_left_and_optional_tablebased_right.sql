...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(51074196272369463)
,p_theme_id=>17
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1045857444395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1045974492395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046069361395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046107439395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046224989395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046386972395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046438078395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046578474395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1046681358395870)
,p_page_template_id=>wwv_flow_api.id(51074196272369463)
