...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029408798600972118)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029409192089972118)
,p_page_template_id=>wwv_flow_api.id(1029408798600972118)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029409600615972119)
,p_page_template_id=>wwv_flow_api.id(1029408798600972118)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029409988587972119)
,p_page_template_id=>wwv_flow_api.id(1029408798600972118)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029410374024972119)
,p_page_template_id=>wwv_flow_api.id(1029408798600972118)
,p_name=>'Header'
