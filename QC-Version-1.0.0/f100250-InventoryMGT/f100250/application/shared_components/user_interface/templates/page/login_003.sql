...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61353619515315701)
,p_theme_id=>7
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1039783272395868)
,p_page_template_id=>wwv_flow_api.id(61353619515315701)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1039860047395868)
,p_page_template_id=>wwv_flow_api.id(61353619515315701)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1039962365395868)
,p_page_template_id=>wwv_flow_api.id(61353619515315701)
