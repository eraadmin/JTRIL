...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10351815323720450758)
,p_theme_id=>152
,p_name=>'Login'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025351251395867)
,p_page_template_id=>wwv_flow_api.id(10351815323720450758)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025428927395867)
,p_page_template_id=>wwv_flow_api.id(10351815323720450758)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025535104395867)
,p_page_template_id=>wwv_flow_api.id(10351815323720450758)
