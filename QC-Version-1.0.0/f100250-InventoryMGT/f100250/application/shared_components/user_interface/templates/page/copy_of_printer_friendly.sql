...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(114933431913495744)
,p_theme_id=>111
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075542617395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075645889395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075783344395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075850156395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1075951435395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1076014058395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1076172625395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1076290012395876)
,p_page_template_id=>wwv_flow_api.id(114933431913495744)
