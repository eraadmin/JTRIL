...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029389095226972105)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029389477183972105)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029389891271972105)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029390285811972105)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029390673839972108)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Side Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029391074738972108)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029391474104972109)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029391890942972109)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029392297215972110)
,p_page_template_id=>wwv_flow_api.id(1029389095226972105)
,p_name=>'Icon Nav Bar'
