...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029384874268972103)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029385272239972103)
,p_page_template_id=>wwv_flow_api.id(1029384874268972103)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029385675953972103)
,p_page_template_id=>wwv_flow_api.id(1029384874268972103)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029386095099972103)
,p_page_template_id=>wwv_flow_api.id(1029384874268972103)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029386496466972103)
,p_page_template_id=>wwv_flow_api.id(1029384874268972103)
,p_name=>'Header'
