prompt --application/shared_components/user_interface/templates/page/microsite
begin
--   Manifest
--     TEMPLATE: MICROSITE
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(992360122383651261)
,p_theme_id=>152
,p_name=>'Microsite'
,p_internal_name=>'MICROSITE'
,p_is_popup=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065477483395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065543369395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065627457395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065702905395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065848903395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1065920448395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1066018758395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1066136305395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1066208945395873)
,p_page_template_id=>wwv_flow_api.id(992360122383651261)
