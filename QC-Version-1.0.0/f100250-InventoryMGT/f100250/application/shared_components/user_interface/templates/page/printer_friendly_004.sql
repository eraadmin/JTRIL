...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10351818205833450763)
,p_theme_id=>152
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034465099395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034589459395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034671372395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034759480395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034808985395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034948926395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1035019545395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1035107773395868)
,p_page_template_id=>wwv_flow_api.id(10351818205833450763)
