...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(114933012072495742)
,p_theme_id=>111
,p_name=>'Copy of No Tabs User'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1078749266395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1078899483395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1078933247395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079056426395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079131048395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079278239395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079382359395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079478449395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1079587919395876)
,p_page_template_id=>wwv_flow_api.id(114933012072495742)
