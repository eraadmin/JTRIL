...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61355936769315707)
,p_theme_id=>7
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1054725446395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1054868235395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1054901371395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055049326395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055198792395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055267838395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055319848395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055400462395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1055538001395871)
,p_page_template_id=>wwv_flow_api.id(61355936769315707)
