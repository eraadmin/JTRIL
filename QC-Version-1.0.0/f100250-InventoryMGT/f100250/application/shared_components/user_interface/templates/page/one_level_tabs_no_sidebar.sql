...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029399176266972114)
,p_theme_id=>25
...
'<div class="apex_grid_container">',
'  <div class="apex_cols apex_span_12">',
'    <section class="uMessageRegion successMessage clearfix" id="SuccessMessage">',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029399587594972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029399996522972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029400395772972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029400801180972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029401180381972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029401573042972115)
,p_page_template_id=>wwv_flow_api.id(1029399176266972114)
,p_name=>'Icon Nav Bar'
