...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61356841495315707)
,p_theme_id=>7
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047320574395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047471326395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047507181395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047657647395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047711314395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047898775395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1047969975395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1048087650395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1048130326395870)
,p_page_template_id=>wwv_flow_api.id(61356841495315707)
