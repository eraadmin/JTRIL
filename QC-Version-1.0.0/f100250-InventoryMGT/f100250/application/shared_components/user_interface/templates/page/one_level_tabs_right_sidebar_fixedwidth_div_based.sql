...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(51072685091369463)
,p_theme_id=>17
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058048644395871)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058136906395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058211669395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058304340395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058474435395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058596146395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058689851395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058724586395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1058858051395873)
,p_page_template_id=>wwv_flow_api.id(51072685091369463)
