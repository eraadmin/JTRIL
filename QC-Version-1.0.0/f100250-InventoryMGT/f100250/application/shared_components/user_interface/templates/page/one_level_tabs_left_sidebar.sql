...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029392593187972110)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029392983049972110)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029393398448972110)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029393774558972110)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029394187141972110)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029394569870972111)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029394980072972111)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029395375569972111)
,p_page_template_id=>wwv_flow_api.id(1029392593187972110)
,p_name=>'Icon Nav Bar'
