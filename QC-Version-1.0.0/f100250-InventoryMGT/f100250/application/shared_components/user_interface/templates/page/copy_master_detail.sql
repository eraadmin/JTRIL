prompt --application/shared_components/user_interface/templates/page/copy_master_detail
begin
--   Manifest
--     TEMPLATE: COPY_MASTER_DETAIL
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(59513891588994136)
,p_theme_id=>111
,p_name=>'Copy_Master_Detail'
,p_internal_name=>'COPY_MASTER_DETAIL'
,p_is_popup=>false
...
'    background-color: #daa10f !important;',
'}',
'',
'.t-Header-branding {',
'    background-color: #daa10f !important;',
...
'        <div id="switch"; style="text-align:right; height:20px; position:absolute;position: absolute; top: 5px;margin-left: 21px; font-size:12px;color:white; font-weight:bold;">',
'   <!-- <button id="page999" style="background-color: green;border-color: green;margin: -2px;color: beige;   width: 200px;" ><a href="f?p=&APP_ID.:1:&SESSION." style="color:white;">HOME</a>',
'            </button>-->',
'        </div>',
' <div>',
'     ',
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59514360970994153)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59514833825994153)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59515290347994155)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59516365468994155)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59516842446994155)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59517288445994155)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59517779010994156)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
,p_name=>'Page Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(59518284022994156)
,p_page_template_id=>wwv_flow_api.id(59513891588994136)
