...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(51074786285369467)
,p_theme_id=>17
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042279898395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042394402395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042449735395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042583231395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042678843395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042788174395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042838804395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1042999720395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1043082757395870)
,p_page_template_id=>wwv_flow_api.id(51074786285369467)
