...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(114934252761495744)
,p_theme_id=>111
,p_name=>'Copy of Register'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068120533395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068254046395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068395392395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068412865395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068529601395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068660938395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068781228395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068884458395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1068967206395875)
,p_page_template_id=>wwv_flow_api.id(114934252761495744)
