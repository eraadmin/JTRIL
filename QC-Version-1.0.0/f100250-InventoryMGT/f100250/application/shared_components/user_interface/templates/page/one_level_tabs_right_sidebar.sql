...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029401872064972115)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029402273847972115)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029402685793972116)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029403083334972116)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029403476795972116)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029403896031972117)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029404294997972117)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029404694723972117)
,p_page_template_id=>wwv_flow_api.id(1029401872064972115)
,p_name=>'Icon Nav Bar'
