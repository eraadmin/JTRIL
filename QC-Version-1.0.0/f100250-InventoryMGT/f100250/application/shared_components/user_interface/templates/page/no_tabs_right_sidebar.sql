...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029386796175972104)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029387186523972104)
,p_page_template_id=>wwv_flow_api.id(1029386796175972104)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029387582004972104)
,p_page_template_id=>wwv_flow_api.id(1029386796175972104)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029387983085972104)
,p_page_template_id=>wwv_flow_api.id(1029386796175972104)
,p_name=>'Right Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029388394897972104)
,p_page_template_id=>wwv_flow_api.id(1029386796175972104)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029388797965972104)
,p_page_template_id=>wwv_flow_api.id(1029386796175972104)
,p_name=>'Header'
