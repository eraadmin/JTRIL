...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(10351817624133450762)
,p_theme_id=>152
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1033666058395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1033797426395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1033898527395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1033903186395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034039226395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034106207395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034299688395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1034303445395868)
,p_page_template_id=>wwv_flow_api.id(10351817624133450762)
