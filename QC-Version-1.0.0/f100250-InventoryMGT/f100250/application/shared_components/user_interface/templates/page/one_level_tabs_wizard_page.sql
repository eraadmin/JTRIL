...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029404969161972117)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029405372699972117)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029405774764972117)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029406176999972117)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029406578266972117)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029406992448972117)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029407397194972118)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
,p_name=>'Header'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029407772334972118)
,p_page_template_id=>wwv_flow_api.id(1029404969161972117)
,p_name=>'Icon Nav Bar'
