...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(61356535832315707)
,p_theme_id=>7
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052002153395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052188121395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052266253395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052336443395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052408738395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1052577075395871)
,p_page_template_id=>wwv_flow_api.id(61356535832315707)
