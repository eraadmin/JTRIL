prompt --application/shared_components/user_interface/templates/page/page_002
begin
--   Manifest
--     TEMPLATE: PAGE
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1733908440482258388)
,p_theme_id=>150
,p_name=>'Page'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025731459395867)
,p_page_template_id=>wwv_flow_api.id(1733908440482258388)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025841335395867)
,p_page_template_id=>wwv_flow_api.id(1733908440482258388)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1025905719395867)
,p_page_template_id=>wwv_flow_api.id(1733908440482258388)
