...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(1029379895904972101)
,p_theme_id=>25
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029380290584972101)
,p_page_template_id=>wwv_flow_api.id(1029379895904972101)
,p_name=>'Main Content'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029380672297972101)
,p_page_template_id=>wwv_flow_api.id(1029379895904972101)
,p_name=>'Breadcrumb'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029381086196972101)
,p_page_template_id=>wwv_flow_api.id(1029379895904972101)
,p_name=>'Left Column'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029381494016972101)
,p_page_template_id=>wwv_flow_api.id(1029379895904972101)
,p_name=>'Footer'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1029381898300972102)
,p_page_template_id=>wwv_flow_api.id(1029379895904972101)
,p_name=>'Header'
