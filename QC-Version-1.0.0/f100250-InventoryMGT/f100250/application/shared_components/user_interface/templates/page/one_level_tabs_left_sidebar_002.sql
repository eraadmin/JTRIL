...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(2725680594392897525)
,p_theme_id=>152
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1036827763395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
,p_name=>'Page Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1036992109395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037035281395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037116454395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037285015395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037319684395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037445487395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(1037586450395868)
,p_page_template_id=>wwv_flow_api.id(2725680594392897525)
