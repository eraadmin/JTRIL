...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(2695018415758811021)
...
'<table cellspacing="0" cellpadding="0" border="0" summary="#WTITLE#" class="WeekCalendarAlternative1Holder">',
'<tr>',
'<td class="MonthTitle"><h1>#WTITLE#</h1></td>',
'</tr>',
'<tr>',
'<td>'))
,p_weekly_day_of_week_format=>'<th class="DayOfWeek" id="#DY#">#IDAY#<br>#MM#/#DD#</th>'
,p_weekly_month_open_format=>'<table border="0" cellpadding="0" cellspacing="0" summary="#WTITLE#" class="WeekCalendarAlternative1">'
...
,p_weekly_time_open_format=>'<th class="Hour" id="#TIME#">'
,p_weekly_time_close_format=>'<br /></th>'
,p_weekly_time_title_format=>'#TIME#'
,p_weekly_hour_open_format=>'<tr>'
,p_weekly_hour_close_format=>'</tr>'
,p_daily_day_of_week_format=>'<th class="DayOfWeek" id="#DY#">#IDAY# #DD#/#MM#</th>'
,p_daily_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="#IMONTH# #DD#, #YYYY#" class="DayCalendarAlternative1Holder"> <tr><td class="MonthTitle"><h1>#IMONTH# #DD#, #YYYY#</h1></td></tr><tr><td>',
''))
,p_daily_month_open_format=>'<table border="0" cellpadding="0" cellspacing="0" summary="#IMONTH#_#DD#_#YYYY#" class="DayCalendarAlternative1">'
...
,p_daily_time_open_format=>'<th class="Hour" id="#TIME#">'
