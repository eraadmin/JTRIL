prompt --application/shared_components/user_interface/templates/report/freeze_report
begin
--   Manifest
--     ROW TEMPLATE: FREEZE_REPORT
--   Manifest End
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(38363507672127553)
,p_row_template_name=>'Freeze Report'
,p_internal_name=>'FREEZE_REPORT'
