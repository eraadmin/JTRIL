prompt --application/shared_components/user_interface/templates/report/microsite_report
begin
--   Manifest
--     ROW TEMPLATE: MICROSITE_REPORT
--   Manifest End
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(993585324918440421)
,p_row_template_name=>'Microsite Report'
,p_internal_name=>'MICROSITE_REPORT'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#">#COLUMN_VALUE#</td>'
,p_row_template3=>'<td #ALIGNMENT# headers="#COLUMN_HEADER_NAME#" class="uOddRow">#COLUMN_VALUE#</td>'
,p_row_template_before_rows=>'<table summary="#REGION_TITLE#" class="db-microsite-table">'
