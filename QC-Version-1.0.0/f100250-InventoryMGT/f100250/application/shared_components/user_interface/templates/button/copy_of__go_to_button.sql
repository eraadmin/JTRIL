prompt --application/shared_components/user_interface/templates/button/copy_of__go_to_button
begin
--   Manifest
--     BUTTON TEMPLATE: COPY_OF_[_>_]_GO_TO_BUTTON
--   Manifest End
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(51669367511344144)
,p_template_name=>'Copy of [ > ] Go To Button'
,p_internal_name=>'COPY_OF_[_>_]_GO_TO_BUTTON'
