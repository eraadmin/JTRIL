prompt --application/shared_components/user_interface/templates/button/mybutton
begin
--   Manifest
--     BUTTON TEMPLATE: MYBUTTON
--   Manifest End
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(67058824523568047)
,p_template_name=>'MyButton'
,p_internal_name=>'MYBUTTON'
