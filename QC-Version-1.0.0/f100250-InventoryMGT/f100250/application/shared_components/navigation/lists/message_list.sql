prompt --application/shared_components/navigation/lists/message_list
begin
--   Manifest
--     LIST: Message list
--   Manifest End
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(60158657823794441)
,p_name=>'Message list'
,p_list_type=>'SQL_QUERY'
,p_list_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select p.value Today, c.value "This Month",d.value "This Year",e.value "Booking",f.value "Not Booking"',
