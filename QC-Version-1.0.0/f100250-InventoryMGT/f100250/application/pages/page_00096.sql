...
,p_last_upd_yyyymmddhh24miss=>'20191016212403'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136747657564355168)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136748444933355171)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136748848885355171)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(136748444933355171)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136749263985355171)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(136748848885355171)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136749582316355173)
...
||'- &P96_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P96_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136751242109355176)
...
'            AND docttype = ''PR''',
'            AND subttype = 1',
'            AND postflag = :P96_POSTSTATUS--DECODE (:P96_POSTSTATUS, ''M'', ''NEW'', statuscd)',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P96_POSTSTATUS'
,p_plug_display_condition_type=>'NEVER'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(136751645986355176)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>99596778860674682
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136751748382355177)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136752144587355179)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136752542781355179)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136752921842355179)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136753298979355179)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136753755763355179)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136754080201355181)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136754523661355181)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136754944594355181)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136755276781355181)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(136755672700355181)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'996009'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(136760255246355185)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136760570739355185)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136760999717355188)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136761467031355188)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136761795203355188)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136762173544355188)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136762665564355188)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136763041949355188)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136763437974355188)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136763805645355188)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136764265883355190)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136764623893355190)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136765010532355190)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136765398205355191)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(136765845020355191)
,p_name=>'Reports'
,p_region_name=>'IR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136766244003355193)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136766612327355193)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136767016329355193)
...
'           and s.UPDOCNUM =a.docnumbr)*/ sum(s.APPRQNTY) Receive_qty,',
...
'          AND a.docttype = :P96_TRANTYPE',
'            AND a.subttype = :P96_SUBTTYPE',
...
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P96_POSTSTATUS,P96_TRANTYPE,P96_SUBTTYPE'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(136767384987355193)
,p_name=>'test'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link=>'f?p=&APP_ID.:97:&SESSION.::&DEBUG.::P97_DOCNUMBR1,P97_DOCTDATE1,P97_WARECODE,P97_ITEMCODE1,P97_ROWID:#DOCNUMBR#,#DOCTDATE#,#WARECODE#,#ITEMCODE#,#ROWID##ROWID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_owner=>'RILADM'
,p_internal_uid=>99612517861674699
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136767513776355193)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136767917688355193)
,p_db_column_name=>'DOCDETAIL'
,p_display_order=>2
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136768350695355193)
,p_db_column_name=>'CHECKBOX'
,p_display_order=>3
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136768756823355193)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>4
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136769147218355193)
,p_db_column_name=>'DOCTDATE'
,p_display_order=>5
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136769498277355195)
,p_db_column_name=>'ITEMCODE'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136769867159355195)
,p_db_column_name=>'ITEMDESC'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136770347400355195)
,p_db_column_name=>'STATUSCD'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Statuscd'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136770723704355195)
,p_db_column_name=>'PRINT_COLUMN'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Print'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136771113469355195)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136771560306355195)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136771912276355195)
...
'if v_add=''Y'' and :P96_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(136772361325355195)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270054112977979)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270165586977980)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270266829977981)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270347289977982)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270450515977983)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43270591279977984)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48313382110501665)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(136776383189355198)
,p_name=>'Requisition Type'
,p_parent_plug_id=>wwv_flow_api.id(136776035627355198)
,p_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136776843202355198)
,p_query_column_id=>1
,p_column_alias=>'D'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136777169981355198)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(136777590075355198)
,p_query_column_id=>3
,p_column_alias=>'R'
,p_column_display_sequence=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136778025757355198)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(136779605051355198)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136778410353355198)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(136778025757355198)
,p_button_name=>'P96_MOD'
,p_button_static_id=>'P89_MOD'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Mod'
,p_button_redirect_url=>'f?p=&APP_ID.:96:&SESSION.:MOD:&DEBUG.:::'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136778808606355198)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(136778025757355198)
,p_button_name=>'P96_DEL'
,p_button_static_id=>'P89_DEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Del'
,p_button_redirect_url=>'f?p=&APP_ID.:96:&SESSION.:DEL:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136779223774355198)
,p_button_sequence=>15
,p_button_plug_id=>wwv_flow_api.id(136778025757355198)
,p_button_name=>'P96_ENQ'
,p_button_static_id=>'P89_ENQ'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Enq'
,p_button_redirect_url=>'f?p=&APP_ID.:96:&SESSION.:ENQ:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136756176344355182)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(136751242109355176)
,p_button_name=>'P96_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136773629749355195)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(136767016329355193)
,p_button_name=>'P96_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:97:&SESSION.:ADD:&DEBUG.::P97_DOCTTYPE,P97_SUBTTYPE,P97_DOCDESC,P97_S_PRDTYP,P97_S_PRSTYP:&P96_TRANTYPE.,&P96_SUBTTYPE.,&P96_NARATION.,&P96_PRDOCTYP.,&P96_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136748040845355170)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136773209027355195)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P96_DELDOCNUMBER. Really?'', ''DELETE'');'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(136756608182355182)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(56517455927595948)
,p_name=>'P96_RANDOMNO'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136750029304355176)
,p_name=>'P96_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(136749582316355173)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136750437761355176)
,p_name=>'P96_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(136749582316355173)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136750855223355176)
,p_name=>'P96_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(136749582316355173)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136757064394355182)
,p_name=>'P96_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_prompt=>'Itemcode'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136757442799355182)
,p_name=>'P96_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136757783634355182)
,p_name=>'P96_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136758212738355182)
,p_name=>'P96_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_prompt=>'Xurltest'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136758635421355182)
,p_name=>'P96_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_prompt=>'Xurl'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136759001166355182)
,p_name=>'P96_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136759392736355184)
,p_name=>'P96_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136759773381355185)
,p_name=>'P96_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(136751242109355176)
,p_item_default=>'0'
,p_prompt=>'S H Region'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136774031897355196)
,p_name=>'P96_POSTSTATUS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136774400564355196)
,p_name=>'P96_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136774804078355196)
,p_name=>'P96_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136775258051355196)
,p_name=>'P96_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136775631755355196)
,p_name=>'P96_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(136767016329355193)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136780044292355199)
,p_name=>'P96_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(136779605051355198)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136780430087355199)
,p_name=>'P96_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(136779605051355198)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(136780809399355199)
,p_name=>'P96_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(136779605051355198)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(136781328906355201)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(136781719594355202)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136783659377355206)
,p_name=>'set value on P96_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136784153009355212)
,p_event_id=>wwv_flow_api.id(136783659377355206)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P96_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136784555174355213)
,p_name=>'set value on P96_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136785033700355213)
,p_event_id=>wwv_flow_api.id(136784555174355213)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P96_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P96_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136785390952355215)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136785915149355215)
,p_event_id=>wwv_flow_api.id(136785390952355215)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P96_XURLTEST;',
'end;'))
,p_attribute_02=>'P96_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136786329206355215)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136786858631355216)
,p_event_id=>wwv_flow_api.id(136786329206355215)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136787248883355218)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136787721529355218)
,p_event_id=>wwv_flow_api.id(136787248883355218)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136788128539355218)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136788594463355218)
,p_event_id=>wwv_flow_api.id(136788128539355218)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(136765845020355191)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136789023491355220)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136789536045355220)
,p_event_id=>wwv_flow_api.id(136789023491355220)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P96_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P96_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(136789924858355220)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(136790424775355221)
,p_event_id=>wwv_flow_api.id(136789924858355220)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(11394626132400692)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(11394660300400693)
,p_event_id=>wwv_flow_api.id(11394626132400692)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(136781998310355202)
...
'',
'',
'If :P96_PROGNM  is null and :P96_NO is null then',
'   :P96_PROGNM := :FX_PROG_NAME;',
'   :P96_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P96_PROGNM,',
'                                      p_parentnm =>:P96_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P96_OPRSTAMP := :app_user;',
'  --:P96_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P96_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P96_PROGNM;',
'   :FX_PAGE_NO := :P96_NO;',
'Elsif :FX_PROG_NAME <> :P96_PROGNM And :FX_PAGE_NO <> :P96_NO Then',
'   :FX_PROG_NAME := :P96_PROGNM;',
'   :FX_PAGE_NO := :P96_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(136782462953355204)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(136783260600355206)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P96_DELDOCNUMBER);',
'begin',
'   for i in 1 .. l_deldoc.count',
'   loop',
'      delete from nmprocur  where docnumbr   = l_deldoc(i) ',
'      and COMPCODE=:COMPCODE ',
'      and DOCTTYPE=:P96_TRANTYPE ',
'      and SUBTTYPE=:P96_SUBTTYPE',
'      and POSTFLAG=:P96_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(136782805933355206)
