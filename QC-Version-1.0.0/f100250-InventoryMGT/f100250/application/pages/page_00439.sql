...
,p_page_mode=>'MODAL'
,p_step_title=>'Issue Return Report'
...
,p_last_upd_yyyymmddhh24miss=>'20201103152859'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(309163190155183588)
...
'',
'class="iR"></i></span></a></div>'' print_column,',
'UPDOCNUM',
'           FROM nmstkrec  s',
'           WHERE compcode = :compcode ',
'            AND docttype = :P439_TRANTYPE --:P439_PRDOCTYP',
'            AND subttype = :P439_SUBTTYPE --:P439_PRSUBTYP',
'            --AND POSTFLAG = :P439_POSTSTATUS',
...
,p_ajax_items_to_submit=>'P439_TRANTYPE,P439_SUBTTYPE,P439_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(309163562191183590)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>309163562191183590
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47373396354912829)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47373759341912829)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47374150153912829)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47374523860912831)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47374901446912835)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47375278504912835)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47375640483912835)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47376017055912839)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47376446018912840)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47376865009912842)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47377288238912842)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47377680896912843)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47378025121912843)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47378447681912843)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47372145841912828)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47372556378912829)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47372905545912829)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(309168873417183593)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'473788'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMCODE:ITEMDESC:WARECODE_FROM:WARECODE_TO:UPDOCNUM:RAISED_BY:PRINT_COLUMN:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(309171357747183594)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(325483522890051363)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47379226668912848)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(309171357747183594)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47379684151912848)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_api.id(309163190155183588)
...
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P439_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47380025573912848)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:296:&SESSION.::&DEBUG.:296:P296_DOCTTYPE,P296_SUBTTYPE,P296_DOCDESC,P296_S_PRDTYP,P296_S_PRSTYP:&P439_TRANTYPE.,&P439_SUBTTYPE.,&P439_NARATION.,&P439_PRDOCTYP.,&P439_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47380474662912848)
,p_name=>'P439_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(309163190155183588)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47380885875912851)
,p_name=>'P439_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(309163190155183588)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47381232959912851)
,p_name=>'P439_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(309163190155183588)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47381662258912851)
,p_name=>'P439_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(309163190155183588)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47382084391912851)
,p_name=>'P439_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(309163190155183588)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47388519101912875)
,p_name=>'P439_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(325483522890051363)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47388901306912876)
,p_name=>'P439_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(325483522890051363)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT prsubtyp',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47389376531912876)
,p_name=>'P439_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(325483522890051363)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47389810314912878)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47390279986912878)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47392516476912882)
,p_name=>'set value on P439_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47393039703912882)
,p_event_id=>wwv_flow_api.id(47392516476912882)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P439_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47393407041912884)
,p_name=>'set value on P439_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47393942553912885)
,p_event_id=>wwv_flow_api.id(47393407041912884)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P439_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P439_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47394396909912885)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47394899291912885)
,p_event_id=>wwv_flow_api.id(47394396909912885)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P439_XURLTEST;',
'end;'))
,p_attribute_02=>'P439_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47395284652912885)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47395725540912885)
,p_event_id=>wwv_flow_api.id(47395284652912885)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47396196838912885)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47396657540912887)
,p_event_id=>wwv_flow_api.id(47396196838912885)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47397031777912887)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47397546684912887)
,p_event_id=>wwv_flow_api.id(47397031777912887)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P439_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmwhstrn input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P439_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47397964971912887)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47398440884912887)
,p_event_id=>wwv_flow_api.id(47397964971912887)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47398836862912887)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47399382281912887)
,p_event_id=>wwv_flow_api.id(47398836862912887)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47390528550912879)
...
'',
'',
'If :P439_PROGNM  is null and :P439_NO is null then',
'   :P439_PROGNM := :FX_PROG_NAME;',
'   :P439_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P439_PROGNM,',
'                                      p_parentnm =>:P439_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P439_OPRSTAMP := :app_user;',
'  --:P439_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P439_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P439_PROGNM;',
'   :FX_PAGE_NO := :P439_NO;',
'Elsif :FX_PROG_NAME <> :P439_PROGNM And :FX_PAGE_NO <> :P439_NO Then',
'   :FX_PROG_NAME := :P439_PROGNM;',
'   :FX_PAGE_NO := :P439_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47390971056912881)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47391782133912881)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P439_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47392137967912882)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(47379226668912848)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47391308998912881)
