...
,p_name=>'Sales Invoice From Generate Leads'
,p_page_mode=>'MODAL'
,p_step_title=>'Sales Invoice From Generate Leads'
...
,p_last_upd_yyyymmddhh24miss=>'20171129162932'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204894542092961176)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204895700224961178)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204896140244961179)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(204895700224961178)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204896527245961181)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(204896140244961179)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204896869141961181)
...
||'- &P312_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P312_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204898497006961189)
...
'            AND docttype = ''PR''',
'            AND subttype = 1',
'            AND postflag = :P312_POSTSTATUS--DECODE (:P312_POSTSTATUS, ''M'', ''NEW'', statuscd)',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P312_POSTSTATUS'
,p_plug_display_condition_type=>'NEVER'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(204898947231961190)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>237245330301362534
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46967841176865579)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46968278728865580)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46968628103865580)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46969084521865580)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46969445730865580)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46969856867865580)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46970238247865585)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46970712860865585)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46971085669865585)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46971432467865585)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(204902881562961260)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'793182'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(204907729113961302)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46981804689865630)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46976993202865608)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46977330729865616)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46977722530865616)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46978165176865616)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46978518433865616)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46978957012865618)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46979342395865618)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46979796334865621)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46980182649865621)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46980608798865625)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46980960398865625)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46981321499865630)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(204913279420961324)
,p_name=>'Reports'
,p_region_name=>'IR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46982428983865636)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(46982757527865636)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204914450043961326)
,p_plug_name=>'Sales Invoice From Generate Leads'
...
'            raisedfrom,',
'                s.statuscd AS statuscd,sum(s.APPRQNTY) sale_qty,(select sum(b.APPRQNTY) from nmslsofr b where b.compcode=s.compcode and b.DOCNUMBR=s.UPDOCNUM and b.ITEMCODE=s.ITEMCODE and b.DOCTTYPE=''SO'' and b.SUBTTYPE=2) offer_qty,',
...
'           FROM nmsalrec s',
'           WHERE compcode = :compcode ',
'            AND s.docttype = :P312_TRANTYPE',
'            AND subttype = :P312_SUBTTYPE',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'                                group by s.COMPCODE,s.RAISEDBY,s.postflag,s.itemcode, s.WARECODE,s.DOCTTYPE, s.SUBTTYPE, s.DOCNUMBR,s.UPDOCNUM, s.DOCTDATE,s.statuscd',
'  -- group by COMPCODE, DOCTTYPE, SUBTTYPE, DOCNUMBR, DOCTDATE,statuscd',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P312_TRANTYPE,P312_SUBTTYPE'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(204914883066961329)
,p_name=>'test'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link=>'f?p=&APP_ID.:313:&SESSION.:MOD:&DEBUG.::P313_ORDERNO,P313_DOCNUMBR1,P313_DOCTDATE,P313_DOCTTYPE,P313_SUBTTYPE,P313_ITEMCODE1,P313_ROWID:#UPDOCNUM#,#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#,#ITEMCODE#,#ROWID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_icon_view_columns_per_row=>1
,p_owner=>'RILADM'
,p_internal_uid=>237261266136362673
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46985890591865644)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46986259822865644)
,p_db_column_name=>'DOCDETAIL'
,p_display_order=>2
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46986633017865644)
,p_db_column_name=>'CHECKBOX'
,p_display_order=>3
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46987042018865647)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>4
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46987486403865647)
,p_db_column_name=>'DOCTDATE'
,p_display_order=>5
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46987852132865649)
,p_db_column_name=>'ITEMCODE'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46988257052865649)
,p_db_column_name=>'ITEMDESC'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46988688881865649)
,p_db_column_name=>'STATUSCD'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Statuscd'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46989043594865650)
,p_db_column_name=>'PRINT_COLUMN'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Print'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46989434327865650)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46989902133865650)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46990255576865650)
...
,p_display_condition=>'P312_REQUEST'
,p_display_condition2=>'DEL'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46983459498865641)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46983825258865643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46984254460865643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46984683244865643)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46985065623865644)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(46985422247865644)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(204920205574961349)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'793370'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMDESC:SALE_QTY:OFFER_QTY:DELIVERY_QTY:RAISEDBY:RAISEDFROM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(216135149883686186)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46973017899865593)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(204898497006961189)
,p_button_name=>'P312_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46972269681865593)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46991043953865650)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(204914450043961326)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46991438827865650)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P312_DELDOCNUMBER. Really?'', ''DELETE'');'
...
'if v_add=''Y'' and :P312_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46991851949865652)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:313:&SESSION.::&DEBUG.:313:P313_DOCTTYPE,P313_SUBTTYPE,P313_DOCDESC,P313_S_PRDTYP,P313_S_PRSTYP:&P312_TRANTYPE.,&P312_SUBTTYPE.,&P312_NARATION.,&P312_PRDOCTYP.,&P312_PRSUBTYP.'
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(46972711673865593)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46973496077865593)
,p_name=>'P312_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_prompt=>'Itemcode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46973852896865594)
,p_name=>'P312_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46974228639865599)
,p_name=>'P312_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46974671690865599)
,p_name=>'P312_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_prompt=>'Xurltest'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46975027964865599)
,p_name=>'P312_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_prompt=>'Xurl'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46975427971865599)
,p_name=>'P312_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46975900180865599)
,p_name=>'P312_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46976254872865602)
,p_name=>'P312_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(204898497006961189)
,p_item_default=>'0'
,p_prompt=>'S H Region'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46992234178865652)
,p_name=>'P312_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204914450043961326)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46992633429865652)
,p_name=>'P312_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(204914450043961326)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46993036234865652)
,p_name=>'P312_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(204914450043961326)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46993456562865652)
,p_name=>'P312_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(204914450043961326)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46993861434865652)
,p_name=>'P312_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(204914450043961326)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46994599035865652)
,p_name=>'P312_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(216135149883686186)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46995008368865654)
,p_name=>'P312_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(216135149883686186)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46995393132865654)
,p_name=>'P312_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(216135149883686186)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46996943051865657)
,p_name=>'P312_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204896869141961181)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46997401146865657)
,p_name=>'P312_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(204896869141961181)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(46997752313865657)
,p_name=>'P312_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(204896869141961181)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(46998552497865657)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(46999009676865727)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47000760781865749)
,p_name=>'set value on P312_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47001305487865749)
,p_event_id=>wwv_flow_api.id(47000760781865749)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P312_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47001559227865863)
,p_name=>'set value on P312_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47002047385865864)
,p_event_id=>wwv_flow_api.id(47001559227865863)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P312_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P312_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47002442807865864)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47002987661865864)
,p_event_id=>wwv_flow_api.id(47002442807865864)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P312_XURLTEST;',
'end;'))
,p_attribute_02=>'P312_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47003317177865866)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47003903668865866)
,p_event_id=>wwv_flow_api.id(47003317177865866)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47004232541865866)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47004788314865867)
,p_event_id=>wwv_flow_api.id(47004232541865866)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47005165781865867)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47005681871865903)
,p_event_id=>wwv_flow_api.id(47005165781865867)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(204913279420961324)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47006028860865903)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47006605094865903)
,p_event_id=>wwv_flow_api.id(47006028860865903)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P312_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P312_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47006928196865945)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47007323939865947)
,p_event_id=>wwv_flow_api.id(47006928196865945)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(46999242357865728)
...
'',
'',
'If :P312_PROGNM  is null and :P312_NO is null then',
'   :P312_PROGNM := :FX_PROG_NAME;',
'   :P312_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P312_PROGNM,',
'                                      p_parentnm =>:P312_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P312_OPRSTAMP := :app_user;',
'  --:P312_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P312_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P312_PROGNM;',
'   :FX_PAGE_NO := :P312_NO;',
'Elsif :FX_PROG_NAME <> :P312_PROGNM And :FX_PAGE_NO <> :P312_NO Then',
'   :FX_PROG_NAME := :P312_PROGNM;',
'   :FX_PAGE_NO := :P312_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(46999712352865728)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47000401556865749)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P312_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47000110837865747)
