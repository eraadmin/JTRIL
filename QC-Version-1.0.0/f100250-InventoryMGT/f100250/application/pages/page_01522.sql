prompt --application/pages/page_01522
begin
--   Manifest
--     PAGE: 01522
--   Manifest End
...
,p_last_upd_yyyymmddhh24miss=>'20170530164037'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(134473771550406629)
...
||'- &P1522_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P1522_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(134478359670406663)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73687568764504520)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73687999736504520)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73688368415504520)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73688848228504520)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73689251214504520)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73689656882504520)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73690050283504520)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73690444016504520)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73690810174504520)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73691231966504520)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73691605154504521)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73691998853504521)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(73692455756504521)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(182914746722029364)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(183056855574452139)
...
'SELECT    docnumbr, docttype,subttype,a.doctdate, a.SLSOFRNO,q.TGT_FG_ITEMCODE,q.BATCH_NO,q.WARECODE',
'  FROM nmslsofr a,',
...
'                 WARECODE',
'            FROM prbom_batch p',
'        GROUP BY SLSOFRNO_FK, TGT_FG_ITEMCODE,RAW_ITEM_CONSUMPTION_FLAG,BATCH_NO,WARECODE) q',
...
,p_ajax_items_to_submit=>'P1522_TRANTYPE,P1522_SUBTTYPE'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(183056945529452139)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>145902078403771645
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(73695789067504531)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>4
,p_column_identifier=>'D'
,p_column_label=>'Budget No'
,p_column_link=>'f?p=&APP_ID.:1514:&SESSION.::&DEBUG.:1514:P1514_SALESOFFER,P1514_ITEMCODE,P1514_BATCH,P1514_WARECODE:#SLSOFRNO#,#TGT_FG_ITEMCODE#,#BATCH_NO#,#WARECODE#'
,p_column_linktext=>'#DOCNUMBR#'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(73696198287504532)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72968885347376325)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72969012266376326)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72969106683376327)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(72969243652376328)
,p_db_column_name=>'TGT_FG_ITEMCODE'
,p_display_order=>45
,p_column_identifier=>'Z'
,p_column_label=>'Tgt fg itemcode'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(73722482917562681)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(73855729412804137)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(183061239164453704)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'365417'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCNUMBR:DOCTDATE:DOCTTYPE:SUBTTYPE:SLSOFRNO:TGT_FG_ITEMCODE:BATCH_NO:WARECODE'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(202703733646818816)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(73693125683504521)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(182914746722029364)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(73697048523504535)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(183056855574452139)
,p_button_name=>'P1522_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:1510:&SESSION.:ADD:&DEBUG.::P88_DOCTTYPE,P88_SUBTTYPE,P88_DOCDESC,P88_S_PRDTYP,P88_S_PRSTYP:&P1522_TRANTYPE.,&P1522_SUBTTYPE.,&P1522_NARATION.,&P1522_PRDOCTYP.,&P1522_PRSUBTYP.'
,p_button_condition_type=>'NEVER'
,p_security_scheme=>wwv_flow_api.id(60507628718248520)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(73697428320504535)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P1522_DELDOCNUMBER. Really?'', ''DELETE'');'
...
'if v_add=''Y'' and :P1522_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73697789741504535)
,p_name=>'P1522_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(183056855574452139)
,p_prompt=>'Trantype'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73698192026504540)
,p_name=>'P1522_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(183056855574452139)
,p_prompt=>'Subttype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73698658697504541)
,p_name=>'P1522_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(183056855574452139)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73698996387504543)
,p_name=>'P1522_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(183056855574452139)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73699746607504545)
,p_name=>'P1522_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(202703733646818816)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73700131380504545)
,p_name=>'P1522_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(202703733646818816)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73700500848504545)
,p_name=>'P1522_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(202703733646818816)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73701173775504546)
,p_name=>'P1522_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(134473771550406629)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73701593915504546)
,p_name=>'P1522_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(134473771550406629)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(73701986103504546)
,p_name=>'P1522_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(134473771550406629)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(73702521124504549)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(73702869863504551)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73704810740504552)
,p_name=>'set value on P1522_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73705283485504555)
,p_event_id=>wwv_flow_api.id(73704810740504552)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1522_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73705679178504555)
,p_name=>'set value on P1522_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73706184787504555)
,p_event_id=>wwv_flow_api.id(73705679178504555)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1522_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P1522_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73706567231504560)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73707157691504563)
,p_event_id=>wwv_flow_api.id(73706567231504560)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73707566767504563)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73708030373504563)
,p_event_id=>wwv_flow_api.id(73707566767504563)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73708422875504565)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73708958609504565)
,p_event_id=>wwv_flow_api.id(73708422875504565)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73709326689504565)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73709693801504565)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73710211015504566)
,p_event_id=>wwv_flow_api.id(73709693801504565)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1522_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P1522_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(73710577229504566)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(73711138791504566)
,p_event_id=>wwv_flow_api.id(73710577229504566)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73704009929504552)
...
'',
'',
'If :P1522_PROGNM  is null and :P1522_NO is null then',
'   :P1522_PROGNM := :FX_PROG_NAME;',
'   :P1522_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P1522_PROGNM,',
'                                      p_parentnm =>:P1522_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P1522_OPRSTAMP := :app_user;',
'  --:P1522_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P1522_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P1522_PROGNM;',
'   :FX_PAGE_NO := :P1522_NO;',
'Elsif :FX_PROG_NAME <> :P1522_PROGNM And :FX_PAGE_NO <> :P1522_NO Then',
'   :FX_PROG_NAME := :P1522_PROGNM;',
'   :FX_PAGE_NO := :P1522_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73703193233504551)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73704403692504552)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P1522_DELDOCNUMBER);',
'begin',
'   for i in 1 .. l_deldoc.count',
'   loop',
'      delete from nmprocur  where docnumbr   = l_deldoc(i) ',
'      and COMPCODE=:COMPCODE ',
'      and DOCTTYPE=:P1522_TRANTYPE ',
'      and SUBTTYPE=:P1522_SUBTTYPE',
'      and POSTFLAG=:P1522_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(73703597696504552)
