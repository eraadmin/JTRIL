...
,p_name=>'Delivery Challan Report'
,p_page_mode=>'MODAL'
,p_step_title=>'Delivery Challan Report'
...
'$(''#nmsalinv_toolbar'').append($(''#P57_POSTSTATUS_CONTAINER''));',
'//$(''#P10_POSTSTATUS_CONTAINER'').css(''margin-left'', ''-800px'');',
'$(function(){',
...
,p_last_upd_yyyymmddhh24miss=>'20191121151220'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253431478420850370)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253432636552850372)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253433076572850373)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(253432636552850372)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253433463573850375)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(253433076572850373)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253433805469850375)
...
||'- &P304_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P304_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253435433334850383)
...
'            AND docttype = ''PR''',
'            AND subttype = 1',
'            AND postflag = :P304_POSTSTATUS--DECODE (:P304_POSTSTATUS, ''M'', ''NEW'', statuscd)',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P304_POSTSTATUS'
,p_plug_display_condition_type=>'NEVER'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(253435883559850384)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>285782266629251728
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39102153665748542)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39102499727748544)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39102869025748544)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39103291994748544)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39103619887748545)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39104099300748545)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39104418361748545)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39104910671748545)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39105267557748547)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39105624819748547)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(253439817890850454)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'714524'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(253444665441850496)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39111160781748614)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39111610681748614)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39111945052748616)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39112318280748616)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39112811413748616)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39113124953748617)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39113569844748617)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39113918605748617)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39114364921748619)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39114749467748619)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39115148414748619)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39115530644748619)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39116005865748619)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(253450215748850518)
,p_name=>'Reports'
,p_region_name=>'IR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39116683737748628)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(39117064776748644)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(253451386371850520)
,p_plug_name=>'Purchase Requisition Entry'
,p_region_name=>'nmsalinv'
,p_region_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47587389655858184)
...
'                || ''/''',
'                || s.subttype AS docdetail,',
's.docttype,s.subttype,count(s.itemcode) Unit,',
'               apex_item.checkbox (1,',
'                           s.DOCNUMBR,',
'                           ''onchange="spCheckChange(this);"'',',
'                           :f_empno_list,',
'                           '',''',
'                          ) checkbox,',
'                apex_item.checkbox2(11, s.DOCNUMBR) delcheckbox,',
'                s.docnumbr AS dev_DOCNUMBR, s.doctdate AS dev_DOCTDATE,',
...
'            wm_concat(distinct c.PRTYNAME) CUSTMR_NAME, wm_concat(distinct c.PARTYAD1) ADDRESS, wm_concat(distinct c.PEMAILID) CUSTMAIL, wm_concat(distinct c.MOBILENO) PHONE,',
...
'    -webkit-transition: all 150ms ease;',
'    transition: all 150ms ease;" type="button">Print</button><i class="iR"></i></span></a></div>'' print_column',
'           FROM nmdevrec s,nmsalrec b,sycompty c',
'           WHERE s.compcode = :compcode ',
'           and s.compcode=b.compcode',
'           and s.UPDOCNUM=b.DOCNUMBR',
'            and s.compcode=c.compcode(+)',
'             and s.PARTYCDE=c.PARTYCDE(+)',
'            AND s.docttype = :P304_TRANTYPE',
'            AND s.subttype = :P304_SUBTTYPE',
'         --   AND s.STATUSCD =:P304_POSTSTATUS',
...
'       ORDER BY s.doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P304_TRANTYPE,P304_SUBTTYPE,P304_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(253451819394850523)
,p_name=>'test'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link=>'f?p=&APP_ID.:305:&SESSION.:MOD:&DEBUG.::P305_DOCNUMBR1,P305_INVOICENO,P305_DOCTDATE,P305_DOCTTYPE,P305_SUBTTYPE,P305_ITEMCODE1,P305_ROWID:#DOCNUMBR#,#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#,#ITEMCODE#,#ROWID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_icon_view_columns_per_row=>1
,p_owner=>'RILADM'
,p_internal_uid=>285798202464251867
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39118914597748695)
,p_db_column_name=>'PRINT_COLUMN'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Print'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39119287941748695)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39119695210748756)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39124515960748759)
,p_db_column_name=>'ITEMDESC'
,p_display_order=>32
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39121639454748759)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39125700263748761)
,p_db_column_name=>'ITEMCODE'
,p_display_order=>132
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39137069981749026)
,p_db_column_name=>'DEV_DOCNUMBR'
,p_display_order=>422
,p_column_identifier=>'BJ'
,p_column_label=>'Delivery No.'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(39137488213749027)
,p_db_column_name=>'DEV_DOCTDATE'
,p_display_order=>432
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37255579529054404)
,p_db_column_name=>'ID'
,p_display_order=>442
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37255655912054405)
,p_db_column_name=>'DOCDETAIL'
,p_display_order=>452
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37255781458054406)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37255809713054407)
,p_db_column_name=>'CHECKBOX'
,p_display_order=>472
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37255939546054408)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256040607054409)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256122419054410)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256246403054411)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256362293054412)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256480946054413)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256536606054414)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256642929054415)
,p_db_column_name=>'STATUSCD'
,p_display_order=>552
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256778567054416)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256825364054417)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37256983893054418)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(253457141902850543)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'714842'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DEV_DOCNUMBR:DEV_DOCTDATE:CUSTMR_NAME:ADDRESS:CUSTMAIL:PHONE:ITEMDESC:SALE_QTY:OFFER_QTY:DELIVERY_QTY:PRINT_COLUMN:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(264672086211575380)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39106473229748547)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(253435433334850383)
,p_button_name=>'P304_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39106869070748549)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39138155786749095)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(253451386371850520)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39138577896749096)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P304_DELDOCNUMBER. Really?'', ''DELETE'');'
,p_button_condition_type=>'NEVER'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39139012959749096)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:305:&SESSION.::&DEBUG.:306:P305_DOCTTYPE,P305_SUBTTYPE,P305_DOCDESC,P305_S_PRDTYP,P305_S_PRSTYP:&P304_TRANTYPE.,&P304_SUBTTYPE.,&P304_NARATION.,&P304_PRDOCTYP.,&P304_PRSUBTYP.'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(39107240428748549)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39100664328748469)
,p_name=>'P304_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(253433805469850375)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39101051332748469)
,p_name=>'P304_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(253433805469850375)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39101430971748469)
,p_name=>'P304_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(253433805469850375)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39107623142748549)
,p_name=>'P304_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_prompt=>'Itemcode'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39108072997748549)
,p_name=>'P304_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39108442736748586)
,p_name=>'P304_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39108900428748586)
,p_name=>'P304_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_prompt=>'Xurltest'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39109275937748586)
,p_name=>'P304_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_prompt=>'Xurl'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39109656066748588)
,p_name=>'P304_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39110107931748588)
,p_name=>'P304_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39110461651748613)
,p_name=>'P304_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(253435433334850383)
,p_item_default=>'0'
,p_prompt=>'S H Region'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39139391257749096)
,p_name=>'P304_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(253451386371850520)
,p_item_default=>'NEW'
,p_prompt=>'<strong>Post Status</strong>'
,p_display_as=>'NATIVE_RADIOGROUP'
,p_lov=>'STATIC:Approved;APR,Non-Approved;NEW'
,p_cSize=>30
,p_cHeight=>1
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39139739495749098)
,p_name=>'P304_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(253451386371850520)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39140166102749098)
,p_name=>'P304_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(253451386371850520)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39140615766749098)
,p_name=>'P304_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(253451386371850520)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39140959498749099)
,p_name=>'P304_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(253451386371850520)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39141644742749099)
,p_name=>'P304_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(264672086211575380)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39142086456749141)
,p_name=>'P304_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(264672086211575380)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT prsubtyp',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(39142478286749151)
,p_name=>'P304_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(264672086211575380)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(39142929584749152)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(39143374032749169)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39145155144749311)
,p_name=>'set value on P304_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39145634912749357)
,p_event_id=>wwv_flow_api.id(39145155144749311)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P304_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39146031702749357)
,p_name=>'set value on P304_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39146532198749441)
,p_event_id=>wwv_flow_api.id(39146031702749357)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P304_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P304_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39146862019749441)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39147322925749442)
,p_event_id=>wwv_flow_api.id(39146862019749441)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P304_XURLTEST;',
'end;'))
,p_attribute_02=>'P304_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39147747850749466)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39148261079749466)
,p_event_id=>wwv_flow_api.id(39147747850749466)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39148644092749466)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39149165128749466)
,p_event_id=>wwv_flow_api.id(39148644092749466)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39149542390749467)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39150079944749467)
,p_event_id=>wwv_flow_api.id(39149542390749467)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(253450215748850518)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39150445233749467)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39150977370749467)
,p_event_id=>wwv_flow_api.id(39150445233749467)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P304_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P304_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(39151329757749467)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(39151860196749489)
,p_event_id=>wwv_flow_api.id(39151329757749467)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(10892931682188975)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(10893044228188976)
,p_event_id=>wwv_flow_api.id(10892931682188975)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(39143675793749171)
...
'',
'',
'If :P304_PROGNM  is null and :P304_NO is null then',
'   :P304_PROGNM := :FX_PROG_NAME;',
'   :P304_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P304_PROGNM,',
'                                      p_parentnm =>:P304_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P304_OPRSTAMP := :app_user;',
'  --:P304_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P304_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P304_PROGNM;',
'   :FX_PAGE_NO := :P304_NO;',
'Elsif :FX_PROG_NAME <> :P304_PROGNM And :FX_PAGE_NO <> :P304_NO Then',
'   :FX_PROG_NAME := :P304_PROGNM;',
'   :FX_PAGE_NO := :P304_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(39144080528749235)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(39144807080749277)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P304_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(39144515904749277)
