...
,p_step_title=>'Todays Sales Report'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(100985101189348952)
,p_plug_name=>'Todays Sales Report'
...
'       pamtmode',
'  FROM nmsalrec s',
'  where doctdate = TO_DATE (TO_CHAR (SYSDATE, ''MM/DD/RRRR''),',
'                                           ''MM/DD/RRRR''',
'                                          );'))
,p_plug_source_type=>'NATIVE_IR'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(100985504871348952)
,p_name=>'Todays Sales Report'
...
,p_owner=>'RILADM'
,p_internal_uid=>63830637745668458
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100985593087348952)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>1
,p_column_identifier=>'A'
,p_column_label=>'Sales Number'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100986054041348952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100986426862348952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100986857703348952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100987242761348952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100987654236348952)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100987977598348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100988455720348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100988844527348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100989212278348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100989620728348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100989995989348953)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(100990445997348953)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(100990811214348953)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'638360'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(100991322224348955)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(100985101189348952)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(100991735514348955)
,p_name=>'P299_TODSALE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(100985101189348952)
,p_source=>'Today''s Sales Report'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(100992131245348955)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(100992643572348955)
,p_event_id=>wwv_flow_api.id(100992131245348955)
,p_event_result=>'TRUE'
