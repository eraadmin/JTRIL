...
,p_last_upd_yyyymmddhh24miss=>'20170919155857'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(137473763884382418)
,p_plug_name=>'Total Schedule Followup'
...
,p_ajax_items_to_submit=>'P259_SERVICETYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(137474185748382419)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>105599692344969816
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37341046894541960)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37341409832541960)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37341851610541961)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37342224213541961)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37342606264541961)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37343004211541961)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37343484338541962)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37343809582541962)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37339429467541959)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37339831058541959)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37340235129541960)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37340648589541960)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37338993477541959)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(137485894548382424)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'54697'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'DOCDETAIL:Vehicle Info:SALESMAN:CUSTOMER:ADDRESS:MOBILENO:Purchase Date:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(137487231982382425)
,p_plug_name=>' '
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47571367397858173)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37345033503541963)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(137473763884382418)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37345782689541963)
,p_name=>'P259_SERVICETYPE'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(137487231982382425)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37346133318541964)
,p_name=>'Freeze Column'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(137473763884382418)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37346618872541964)
,p_event_id=>wwv_flow_api.id(37346133318541964)
,p_event_result=>'TRUE'
