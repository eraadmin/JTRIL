...
,p_name=>'Stock Receipt (Purchase) Report'
,p_page_mode=>'MODAL'
,p_step_title=>'Stock Receipt (Purchase) Report'
...
,p_last_upd_yyyymmddhh24miss=>'20200429161104'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(58113105249112215)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(168212961851418678)
...
'            raisedfrom,',
'                s.statuscd AS statuscd,sum(s.APPRQNTY) Request_qty,',
'               sum((select sum(b.TRNSQNTY) from nmstkrec b where b.compcode=s.compcode and b.UPDOCNUM=s.DOCNUMBR and b.ITEMCODE=s.ITEMCODE and b.DOCTTYPE=''IS'' and b.SUBTTYPE=2)) Issue_qty,',
...
'               s.WARECODE, s.COSTCODE, s.PARTYCDE, s.BATCHNUM, s.BATCHDTE, s.BATCHEXP,',
...
'            AND docttype = :docttype --:P435_TRANTYPE',
'            AND subttype = :subttype --:P435_SUBTTYPE',
'            AND statuscd = :P435_POSTSTATUS',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'                                group by s.COMPCODE,s.RAISEDBY,s.postflag, s.WARECODE,s.DOCTTYPE, s.SUBTTYPE, s.DOCNUMBR, s.DOCTDATE, s.WARECODE, s.COSTCODE, s.PARTYCDE, s.BATCHNUM, s.BATCHDTE, s.BATCHEXP, s.statuscd',
'  -- group by COMPCODE, DOCTTYPE, SUBTTYPE, DOCNUMBR, DOCTDATE,statuscd',
'       ORDER BY doctdate DESC, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P435_POSTSTATUS'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(168213306859418678)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>168213306859418678
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47242573994369225)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47242906540369226)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47243307925369228)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47243751807369229)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47244114947369231)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47245264034369234)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47245677859369235)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47246060679369237)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47246460766369237)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47246875673369239)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47240179275369207)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47240508134369210)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47240912237369215)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47241345499369218)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47237767491369190)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47238132234369200)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47238587351369201)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47238915742369203)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47239356516369204)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47239700037369206)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58113903797112223)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58114037318112224)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58114177406112225)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(58114276152112226)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(168218606551418682)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'472472'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMCODE:ITEMDESC:REQUEST_QTY:RAISEDFROM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47247655388369245)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(58113105249112215)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47248057123369248)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_api.id(168212961851418678)
...
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P435_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47248481680369250)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:106:&SESSION.::&DEBUG.:106:P106_DOCTTYPE,P106_SUBTTYPE,P106_DOCDESC,P106_S_PRDTYP,P106_S_PRSTYP:&P435_TRANTYPE.,&P435_SUBTTYPE.,&P435_NARATION.,&P435_PRDOCTYP.,&P435_PRSUBTYP.'
,p_required_patch=>wwv_flow_api.id(981178456698168123)
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47248884526369251)
,p_name=>'P435_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
,p_item_default=>'APR'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47249246754369259)
,p_name=>'P435_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47249618587369259)
,p_name=>'P435_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47250052970369259)
,p_name=>'P435_PRDOCTYP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47250408632369259)
,p_name=>'P435_PRSUBTYP'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT prsubtyp',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47250816647369262)
,p_name=>'P435_NARATION'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47251227203369262)
,p_name=>'P435_REQUEST'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47251649904369264)
,p_name=>'P435_DELDOCNUMBER'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(168212961851418678)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47252151477369267)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47252527441369270)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47254894363369276)
,p_name=>'set value on P435_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47255320488369279)
,p_event_id=>wwv_flow_api.id(47254894363369276)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P435_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47255762914369281)
,p_name=>'set value on P435_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47256231631369281)
,p_event_id=>wwv_flow_api.id(47255762914369281)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P435_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P435_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47256667167369281)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47257154938369281)
,p_event_id=>wwv_flow_api.id(47256667167369281)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P435_XURLTEST;',
'end;'))
,p_attribute_02=>'P435_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47260263500369284)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47260772810369284)
,p_event_id=>wwv_flow_api.id(47260263500369284)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47257598572369282)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47258042988369282)
,p_event_id=>wwv_flow_api.id(47257598572369282)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47258448401369282)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47258958235369282)
,p_event_id=>wwv_flow_api.id(47258448401369282)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P435_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmmrstrn input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P435_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47259321881369282)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47259851972369282)
,p_event_id=>wwv_flow_api.id(47259321881369282)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47261152757369284)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47261620288369284)
,p_event_id=>wwv_flow_api.id(47261152757369284)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47254023655369271)
...
'',
'',
'If :P435_PROGNM  is null and :P435_NO is null then',
'   :P435_PROGNM := :FX_PROG_NAME;',
'   :P435_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P435_PROGNM,',
'                                      p_parentnm =>:P435_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P435_OPRSTAMP := :app_user;',
'  --:P435_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P435_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P435_PROGNM;',
'   :FX_PAGE_NO := :P435_NO;',
'Elsif :FX_PROG_NAME <> :P435_PROGNM And :FX_PAGE_NO <> :P435_NO Then',
'   :FX_PROG_NAME := :P435_PROGNM;',
'   :FX_PAGE_NO := :P435_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47254453766369273)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47253661605369271)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P435_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47252876367369270)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(47247655388369245)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47253243384369271)
