...
,p_name=>'Warehouse Issue  Report'
,p_page_mode=>'MODAL'
,p_step_title=>'Warehouse Issue  Report'
...
,p_last_upd_yyyymmddhh24miss=>'20171031105039'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120938137846931452)
...
'            AND docttype = :P100_TRANTYPE',
'            AND subttype = :P100_SUBTTYPE',
...
,p_ajax_items_to_submit=>'P100_TRANTYPE,P100_SUBTTYPE'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(120938509882931454)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>83783642757250960
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120938642556931454)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120939048645931454)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120939448663931454)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120939815253931454)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120940190291931454)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120941017645931454)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120941396072931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120941832929931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120942184653931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120942630798931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120942990073931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120943401427931457)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786909624693076)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786976888693077)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43787089857693078)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43787211198693079)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43787290177693080)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43787353408693081)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(120947561999931458)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120948761736931460)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120949116923931460)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120949509491931460)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120949933927931460)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120950347172931460)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120950747550931460)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120951143253931461)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120951548397931461)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120951905455931461)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120952284031931461)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120952686205931461)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120948346161931460)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120947955856931460)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(137258470581799227)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120946730713931458)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(120938137846931452)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120947136568931458)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P100_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(137312511426826680)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:293:&SESSION.::&DEBUG.:293:P293_DOCTTYPE,P293_SUBTTYPE,P293_DOCDESC,P293_S_PRDTYP,P293_S_PRSTYP:&P100_TRANTYPE.,&P100_SUBTTYPE.,&P100_NARATION.,&P100_PRDOCTYP.,&P100_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120944328398931458)
,p_name=>'P100_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(120938137846931452)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120944762864931458)
,p_name=>'P100_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(120938137846931452)
,p_prompt=>'Trantype'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120945078042931458)
,p_name=>'P100_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(120938137846931452)
,p_prompt=>'Subttype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120945507999931458)
,p_name=>'P100_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(120938137846931452)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120945871872931458)
,p_name=>'P100_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(120938137846931452)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137258778022799227)
,p_name=>'P100_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(137258470581799227)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137259243682799229)
,p_name=>'P100_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(137258470581799227)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137259609289799229)
,p_name=>'P100_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(137258470581799227)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(120953249749931461)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(120953660997931461)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120955565619931469)
,p_name=>'set value on P100_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120956039613931469)
,p_event_id=>wwv_flow_api.id(120955565619931469)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P100_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120956403447931469)
,p_name=>'set value on P100_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120956925714931469)
,p_event_id=>wwv_flow_api.id(120956403447931469)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P100_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120957274825931471)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120957782621931471)
,p_event_id=>wwv_flow_api.id(120957274825931471)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P100_XURLTEST;',
'end;'))
,p_attribute_02=>'P100_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120958256921931472)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120958690573931472)
,p_event_id=>wwv_flow_api.id(120958256921931472)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120959092604931472)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120959638717931472)
,p_event_id=>wwv_flow_api.id(120959092604931472)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120959988918931472)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120960561320931472)
,p_event_id=>wwv_flow_api.id(120959988918931472)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P100_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmwhstrn input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P100_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120960961716931472)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120961391442931476)
,p_event_id=>wwv_flow_api.id(120960961716931472)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120953882050931461)
...
'',
'',
'If :P100_PROGNM  is null and :P100_NO is null then',
'   :P100_PROGNM := :FX_PROG_NAME;',
'   :P100_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P100_PROGNM,',
'                                      p_parentnm =>:P100_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P100_OPRSTAMP := :app_user;',
'  --:P100_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P100_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P100_PROGNM;',
'   :FX_PAGE_NO := :P100_NO;',
'Elsif :FX_PROG_NAME <> :P100_PROGNM And :FX_PAGE_NO <> :P100_NO Then',
'   :FX_PROG_NAME := :P100_PROGNM;',
'   :FX_PAGE_NO := :P100_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120954309864931463)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120955146896931469)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P100_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120954678257931468)
