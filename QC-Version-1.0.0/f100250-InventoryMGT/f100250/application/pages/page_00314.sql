...
,p_name=>'Purchase Request Monitoring'
,p_page_mode=>'MODAL'
,p_step_title=>'Purchase Request Monitoring'
...
,p_last_upd_yyyymmddhh24miss=>'20180830133710'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149840199117341591)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149840383589341591)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(149840199117341591)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149840583854341594)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(149840383589341591)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149840789714341594)
...
||'- &P314_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P314_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(149841783857341595)
...
'            AND docttype = ''PR''',
'            AND subttype = 1',
'            AND postflag = :P314_POSTSTATUS--DECODE (:P314_POSTSTATUS, ''M'', ''NEW'', statuscd)',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P314_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(149841995825341597)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>182188378894742941
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49036898844232623)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49037229015232631)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49037641028232631)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49038044549232631)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49038482487232631)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49038821539232631)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49039275021232633)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49039654660232633)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49040076317232633)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49040499586232633)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(149842992738341615)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'813872'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(149845377834341628)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49045602611232672)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49046005118232676)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49046239845232678)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49046641812232678)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49047018729232678)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49047489164232678)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49047907084232683)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49048288510232683)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49048661792232684)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49049078032232684)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49049480342232684)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49049906073232684)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49050238725232684)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(149846895458341630)
,p_name=>'Reports'
,p_region_name=>'IR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49050947788232686)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49051347246232686)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(198281764885964329)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(198423873738387104)
...
'                a.statuscd AS statuscd,sum(a.APPRQNTY) Request_qty,sum(q.APPRQNTY) Approve_qty,sum((select sum(s.APPRQNTY)  from nmprocur  s where   s.compcode=a.compcode',
'           and s.ITEMCODE=a.ITEMCODE',
'           and s.UPDOCNUM=a.DOCNUMBR and s.DOCTTYPE=''LP'' and s.SUBTTYPE=1) ) Order_qty,sum((select sum(s.APPRQNTY)  from nmstkrec  s where   s.compcode=a.compcode',
'           and s.ITEMCODE=a.ITEMCODE',
'           and s.UPDOCNUM IN (select distinct wm_concat(b.DOCNUMBR) from nmprocur b where b.compcode=a.compcode and b.UPDOCNUM=a.DOCNUMBR and b.ITEMCODE=a.ITEMCODE and b.DOCTTYPE=''LP'' and b.SUBTTYPE=1))) Receive_qty,',
...
'          AND a.docttype =''PR''-- :P314_TRANTYPE',
'            --AND a.subttype = :P314_SUBTTYPE',
'         --   AND a.statuscd = DECODE (:P181_POSTSTATUS, ''M'', ''APR'', a.statuscd)',
'        --    and a.OPRSTAMP=:APP_USER',
'           -- AND a.postflag = :P314_POSTSTATUS',
'            AND (a.costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'                               group by a.COMPCODE,a.RAISEDBY,a.postflag, a.WARECODE,a.DOCTTYPE, a.SUBTTYPE, a.DOCNUMBR, a.DOCTDATE,a.statuscd',
'       ORDER BY a.doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P314_POSTSTATUS,P314_TRANTYPE,P314_SUBTTYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_prn_output_show_link=>'Y'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(198423963693387104)
,p_name=>'test'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_pagination_display_pos=>'BOTTOM_RIGHT'
,p_report_list_mode=>'TABS'
,p_fixed_header_max_height=>50
,p_lazy_loading=>false
,p_show_detail_link=>'N'
,p_show_calendar=>'N'
,p_download_formats=>'XLSX:PDF'
,p_enable_mail_download=>'N'
,p_detail_link=>'f?p=&APP_ID.:88:&SESSION.:MOD:&DEBUG.::P88_DOCNUMBR1,P88_DOCTDATE1,P88_DOCTTYPE,P88_SUBTTYPE,P88_ITEMCODE1,P88_ROWID:#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#,#ITEMCODE#,#ROWID#'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_icon_view_columns_per_row=>1
,p_owner=>'RILADM'
,p_internal_uid=>230770346762788448
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49054718950232706)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49055147943232706)
,p_db_column_name=>'DOCDETAIL'
,p_display_order=>2
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49055533847232708)
,p_db_column_name=>'CHECKBOX'
,p_display_order=>3
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49055992367232709)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>4
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49056369220232717)
,p_db_column_name=>'DOCTDATE'
,p_display_order=>5
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49056727614232722)
,p_db_column_name=>'ITEMCODE'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49057128286232723)
,p_db_column_name=>'ITEMDESC'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49057535128232726)
,p_db_column_name=>'STATUSCD'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Statuscd'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49057950390232729)
,p_db_column_name=>'PRINT_COLUMN'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Print'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49058356503232732)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49058797155232737)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49059141199232742)
...
'if v_add=''Y'' and :P314_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49059525627232743)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49052367408232695)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49052755110232698)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49053214763232700)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49053604511232703)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49053949324232704)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49054342176232704)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(49820110500467899)
,p_db_column_name=>'ORDER_QTY'
,p_display_order=>21
,p_column_identifier=>'U'
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(198428257328388669)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'814063'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMDESC:REQUEST_QTY:APPROVE_QTY:ORDER_QTY:RECEIVE_QTY:RAISEDBY:RAISEDFROM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(218043864433977751)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(218038263335940024)
,p_name=>'Requisition Type'
,p_parent_plug_id=>wwv_flow_api.id(218043864433977751)
,p_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49064139529232773)
,p_query_column_id=>1
,p_column_alias=>'D'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49064521533232775)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(49064964168232775)
,p_query_column_id=>3
,p_column_alias=>'R'
,p_column_display_sequence=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(218045706897987540)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(218070751810753781)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49065651741232776)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(218045706897987540)
,p_button_name=>'P314_MOD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:314:&SESSION.:MOD:&DEBUG.:::'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49065945996232776)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(218045706897987540)
,p_button_name=>'P314_DEL'
...
,p_button_alignment=>'LEFT'
,p_button_redirect_url=>'f?p=&APP_ID.:314:&SESSION.:DEL:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49066377476232776)
,p_button_sequence=>15
,p_button_plug_id=>wwv_flow_api.id(218045706897987540)
,p_button_name=>'P314_ENQ'
...
,p_button_alignment=>'LEFT'
,p_button_redirect_url=>'f?p=&APP_ID.:314:&SESSION.:ENQ:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49041233446232640)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(149841783857341595)
,p_button_name=>'P314_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49060737153232754)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(198423873738387104)
,p_button_name=>'P314_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:88:&SESSION.:ADD:&DEBUG.::P88_DOCTTYPE,P88_SUBTTYPE,P88_DOCDESC,P88_S_PRDTYP,P88_S_PRSTYP:&P314_TRANTYPE.,&P314_SUBTTYPE.,&P314_NARATION.,&P314_PRDOCTYP.,&P314_PRSUBTYP.'
,p_button_condition_type=>'NEVER'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49060343814232751)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49061139917232754)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P314_DELDOCNUMBER. Really?'', ''DELETE'');'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(49041618164232647)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49035459234232550)
,p_name=>'P314_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(149840789714341594)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49035733670232595)
,p_name=>'P314_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(149840789714341594)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49036189205232595)
,p_name=>'P314_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(149840789714341594)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49042059320232648)
,p_name=>'P314_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49042464395232659)
,p_name=>'P314_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49042894117232659)
,p_name=>'P314_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49043231362232659)
,p_name=>'P314_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49043620147232659)
,p_name=>'P314_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49044115689232661)
,p_name=>'P314_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_use_cache_before_default=>'NO'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49044474880232662)
,p_name=>'P314_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49044845622232662)
,p_name=>'P314_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(149841783857341595)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49061551431232754)
,p_name=>'P314_POSTSTATUS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(198423873738387104)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49061984420232767)
,p_name=>'P314_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(198423873738387104)
,p_prompt=>'Trantype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49062395182232767)
,p_name=>'P314_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(198423873738387104)
,p_prompt=>'Subttype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49062803816232767)
,p_name=>'P314_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(198423873738387104)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49063151796232768)
,p_name=>'P314_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(198423873738387104)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49067026457232776)
,p_name=>'P314_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(218070751810753781)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49067509529232778)
,p_name=>'P314_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(218070751810753781)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(49067872736232778)
,p_name=>'P314_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(218070751810753781)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49068397103232786)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(49068746715232789)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49070621861232795)
,p_name=>'set value on P314_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49071140461232801)
,p_event_id=>wwv_flow_api.id(49070621861232795)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P314_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49071554919232809)
,p_name=>'set value on P314_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49072019492232810)
,p_event_id=>wwv_flow_api.id(49071554919232809)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P314_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P314_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49072510861232810)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49072918098232814)
,p_event_id=>wwv_flow_api.id(49072510861232810)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P314_XURLTEST;',
'end;'))
,p_attribute_02=>'P314_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49073408862232814)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49073835966232815)
,p_event_id=>wwv_flow_api.id(49073408862232814)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49074241492232815)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49074798822232815)
,p_event_id=>wwv_flow_api.id(49074241492232815)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49075205935232815)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49075686683232815)
,p_event_id=>wwv_flow_api.id(49075205935232815)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(149846895458341630)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49076097353232820)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49076536545232821)
,p_event_id=>wwv_flow_api.id(49076097353232820)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P314_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P314_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.component_end;
end;
/
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(49076951599232821)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(49077429880232823)
,p_event_id=>wwv_flow_api.id(49076951599232821)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47438875413696314)
,p_name=>'New'
,p_event_sequence=>270
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(49060343814232751)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47438984909696315)
,p_event_id=>wwv_flow_api.id(47438875413696314)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(49069881350232795)
...
'',
'',
'If :P314_PROGNM  is null and :P314_NO is null then',
'   :P314_PROGNM := :FX_PROG_NAME;',
'   :P314_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P314_PROGNM,',
'                                      p_parentnm =>:P314_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P314_OPRSTAMP := :app_user;',
'  --:P314_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P314_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P314_PROGNM;',
'   :FX_PAGE_NO := :P314_NO;',
'Elsif :FX_PROG_NAME <> :P314_PROGNM And :FX_PAGE_NO <> :P314_NO Then',
'   :FX_PROG_NAME := :P314_PROGNM;',
'   :FX_PAGE_NO := :P314_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(49069091882232789)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(49070245363232795)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P314_DELDOCNUMBER);',
'begin',
'   for i in 1 .. l_deldoc.count',
'   loop',
'      delete from nmprocur  where docnumbr   = l_deldoc(i) ',
'      and COMPCODE=:COMPCODE ',
'      and DOCTTYPE=:P314_TRANTYPE ',
'      and SUBTTYPE=:P314_SUBTTYPE',
'      and POSTFLAG=:P314_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(49069430057232795)
