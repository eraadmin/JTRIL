prompt --application/pages/page_10025_010
begin
--   Manifest
--     PAGE: 10025
--   Manifest End
...
,p_name=>'Final Stock Receive Report'
,p_alias=>'FINAL-STOCK-RECEIVE-REPORT'
,p_page_mode=>'MODAL'
,p_step_title=>'Final Stock Receive Report'
...
,p_last_upd_yyyymmddhh24miss=>'20230102121506'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(118782764871271957)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(204390818569186020)
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(204391163577186020)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>204391163577186020
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41724364205676669)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41724739740676670)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41725178402676670)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41725547061676670)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41725976821676671)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41726306992676671)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41726709269676671)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41727188270676671)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41727503110676672)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41721193027676666)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41721542413676667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41721942741676667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41722309970676667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41722789926676668)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41723115990676668)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41718721288676661)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41719181615676663)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41719542891676663)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41719993005676665)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41720396692676665)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41720700365676666)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41723587880676669)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41723917697676669)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(41718369111676660)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(204396463269186024)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'838267'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:RECEIVE_QTY:RAISEDFROM:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41730963284676676)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(118782764871271957)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(41728281714676673)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_api.id(204390818569186020)
,p_button_name=>'reset'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41728618673676673)
,p_name=>'P1002500090_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(204390818569186020)
,p_item_default=>'NEW'
,p_prompt=>'Status'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41729009658676674)
,p_name=>'P1002500090_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(204390818569186020)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41729436800676675)
,p_name=>'P1002500090_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(204390818569186020)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41729832849676675)
,p_name=>'P1002500090_PRDOCTYP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(204390818569186020)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(41730204698676675)
,p_name=>'P1002500090_PRSUBTYP'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(204390818569186020)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT prsubtyp',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(41731371754676677)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(41730963284676676)
);
