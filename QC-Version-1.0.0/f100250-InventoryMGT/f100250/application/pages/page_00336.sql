...
,p_name=>'Cost Finalization ( PO )'
,p_page_mode=>'MODAL'
,p_step_title=>'Cost Finalization ( PO )'
...
,p_dialog_height=>'700'
,p_dialog_width=>'100%'
,p_dialog_attributes=>'position:''top+70'''
,p_dialog_chained=>'N'
...
,p_last_upd_yyyymmddhh24miss=>'20200607185445'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120736530526180120)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120736923090180120)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(120736530526180120)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47571367397858173)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120737276925180120)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(120736923090180120)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47571367397858173)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120737693414180120)
...
||'- &P336_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P336_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120739293113180121)
,p_plug_name=>'Report 1'
,p_region_name=>'nmitrfnl'
...
'            AND docttype = :P336_TRANTYPE',
'            AND subttype = :P336_SUBTTYPE',
'            AND statuscd = DECODE (:P336_POSTSTATUS, ''M'', ''APR'', statuscd)',
...
,p_ajax_items_to_submit=>'P336_TRANTYPE,P336_SUBTTYPE,P336_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(120739696273180123)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:302:&SESSION.::&DEBUG.::P302_DOCNUMBR1,P302_DOCTDATE1,P302_ITEMCODE1,P302_ROWID:#DOCNUMBR#,#DOCTDATE#,#ITEMCODE#,#ROWID#'
...
,p_owner=>'RILADM'
,p_internal_uid=>85401606235415721
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37941798849734496)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37942285867734497)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37942615623734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37943051802734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37943418340734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37943889403734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37944263425734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37944635462734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37945051189734497)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37940624342734496)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37941056767734496)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37941469039734496)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37945445518734497)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(120745433569180124)
...
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'DOCDETAIL:ITEMCODE:ITEMDESC:CHECKBOX:DOCTTYPE:SUBTTYPE:PRINT_COLUMN:DELCHECKBOX:UNIT'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(120752348909180128)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37953743573734500)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37954115207734500)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37954514348734500)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37954953339734500)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37955300626734500)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37955788262734500)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37956107732734500)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37956558816734501)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37956910785734501)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37957389868734501)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37957714873734501)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37958164738734501)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37958550595734501)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(120757907328180132)
,p_name=>'Reports'
,p_region_name=>'IR'
,p_template=>wwv_flow_api.id(47587389655858184)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37959271699734501)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(37959615858734501)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120759127376180134)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(139948556561900094)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37946216366734498)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(120739293113180121)
,p_button_name=>'P336_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37946657691734499)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37960368324734502)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37947029212734499)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P336_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37947463330734499)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:302:&SESSION.::&DEBUG.:302:P302_DOCTTYPE,P302_SUBTTYPE,P302_DOCDESC,P302_S_PRDTYP,P302_S_PRSTYP:&P336_TRANTYPE.,&P336_SUBTTYPE.,&P336_NARATION.,&P336_PRDOCTYP.,&P336_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(37947885031734499)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37939111891734494)
,p_name=>'P336_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(120737693414180120)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37939500377734494)
,p_name=>'P336_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(120737693414180120)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37939980948734494)
,p_name=>'P336_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(120737693414180120)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37948241494734499)
,p_name=>'P336_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37948665230734499)
,p_name=>'P336_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_prompt=>'Itemcode'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37949009003734499)
,p_name=>'P336_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37949391706734499)
,p_name=>'P336_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37949879022734499)
,p_name=>'P336_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_prompt=>'Xurltest'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37950265362734499)
,p_name=>'P336_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_prompt=>'Xurl'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37950652581734499)
,p_name=>'P336_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37951079758734499)
,p_name=>'P336_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37951407221734499)
,p_name=>'P336_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
,p_item_default=>'0'
,p_prompt=>'S H Region'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37951835531734499)
,p_name=>'P336_REQUEST'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37952259394734500)
,p_name=>'P336_TRANTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37952591634734500)
,p_name=>'P336_SUBTTYPE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37953062450734500)
,p_name=>'P336_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(120739293113180121)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37961084478734502)
,p_name=>'P336_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(139948556561900094)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37961463073734502)
,p_name=>'P336_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(139948556561900094)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(37961837187734502)
,p_name=>'P336_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(139948556561900094)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(37962292674734502)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(37962710016734502)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37964638689734506)
,p_name=>'set value on P336_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37965129091734506)
,p_event_id=>wwv_flow_api.id(37964638689734506)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P336_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37965583523734507)
,p_name=>'set value on P336_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37966022010734507)
,p_event_id=>wwv_flow_api.id(37965583523734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P336_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P336_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37966400285734507)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37966918309734507)
,p_event_id=>wwv_flow_api.id(37966400285734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P336_XURLTEST;',
'end;'))
,p_attribute_02=>'P336_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37967369401734507)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37967797072734507)
,p_event_id=>wwv_flow_api.id(37967369401734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37968263818734507)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37968713131734507)
,p_event_id=>wwv_flow_api.id(37968263818734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37969108627734507)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37969655032734507)
,p_event_id=>wwv_flow_api.id(37969108627734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(120757907328180132)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(37970001635734507)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(37970507693734507)
,p_event_id=>wwv_flow_api.id(37970001635734507)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P336_DELVERDOCNUM'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmitrfnl input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P336_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(10640395015434579)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(10640485582434580)
,p_event_id=>wwv_flow_api.id(10640395015434579)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(11392899143400675)
,p_name=>'Change on Poststatus'
,p_event_sequence=>270
,p_triggering_element_type=>'ITEM'
,p_triggering_element=>'P336_POSTSTATUS'
,p_bind_type=>'bind'
,p_bind_event_type=>'change'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(11392967975400676)
,p_event_id=>wwv_flow_api.id(11392899143400675)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(120739293113180121)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(67329579715144250)
,p_name=>'New'
,p_event_sequence=>280
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(37960368324734502)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(69984941065338901)
,p_event_id=>wwv_flow_api.id(67329579715144250)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(37962992040734502)
...
'',
'',
'If :P336_PROGNM  is null and :P336_NO is null then',
'   :P336_PROGNM := :FX_PROG_NAME;',
'   :P336_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P336_PROGNM,',
'                                      p_parentnm =>:P336_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P336_OPRSTAMP := :app_user;',
'  --:P336_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P336_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P336_PROGNM;',
'   :FX_PAGE_NO := :P336_NO;',
'Elsif :FX_PROG_NAME <> :P336_PROGNM And :FX_PAGE_NO <> :P336_NO Then',
'   :FX_PROG_NAME := :P336_PROGNM;',
'   :FX_PAGE_NO := :P336_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(37963449116734502)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(37964286787734506)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P336_DELDOCNUMBER);',
'begin',
'',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(37963851349734506)
