...
,p_last_upd_yyyymmddhh24miss=>'20191015171704'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(144402130078480907)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(144402314550480907)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(144402130078480907)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(144402514815480910)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(144402314550480907)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(144402720675480910)
...
||'- &P309_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P309_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(144403714818480911)
...
'            AND docttype = ''PR''',
'            AND subttype = 1',
'            AND postflag = :P309_POSTSTATUS--DECODE (:P309_POSTSTATUS, ''M'', ''NEW'', statuscd)',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P309_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(144403926786480913)
,p_name=>'Report 1'
...
,p_owner=>'RILADM'
,p_internal_uid=>176750309855882257
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43598801127371923)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43599126131371931)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43599539587371932)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43599993809371932)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43600387606371932)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43600788665371932)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43601136315371938)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43601610734371940)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43601970695371940)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43602382807371940)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(144404923699480931)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'759491'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(144407308795480944)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43607395123371988)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43607722657371993)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43608164204371993)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43608557984371993)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43608962379371993)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43609361275371993)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43609795122371993)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43610191243371995)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43610616029371995)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43610934995371995)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43611363905371996)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43611814589371996)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43612211489371996)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(144408826419480946)
,p_name=>'Reports'
,p_region_name=>'IR'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43612839727371996)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43613311732371996)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(192843695847103645)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(192985804699526420)
,p_plug_name=>'Direct Purchase Order'
...
'                wm_concat(distinct a.itemcode) AS itemcode, wm_concat(distinct a.itemdesc) AS itemdesc,wm_concat(distinct a.DESIGNCD) DESIGNCD,',
...
'           and s.UPDOCNUM IN (select distinct wm_concat(b.DOCNUMBR) from nmprocur b where b.compcode=a.compcode and b.UPDOCNUM=a.DOCNUMBR and b.ITEMCODE=a.ITEMCODE and b.DOCTTYPE=''LP'' and b.SUBTTYPE=1))*/ sum(s.APPRQNTY) Receive_qty,',
'                 (SELECT INITCAP (a.RAISEDBY|| ''-'' || username)',
'            FROM syusrmas',
'           WHERE usercode = a.RAISEDBY) RAISEDBY ,a.WARECODE,',
'           INITCAP (',
...
'          AND a.docttype = :P309_TRANTYPE',
'            AND a.subttype = :P309_SUBTTYPE',
'        --    and a.OPRSTAMP=:APP_USER',
'           -- AND a.postflag = :P309_POSTSTATUS',
...
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P309_POSTSTATUS,P309_TRANTYPE,P309_SUBTTYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
,p_prn_output_show_link=>'Y'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(192985894654526420)
,p_name=>'test'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'The maximum row count for this report is #MAX_ROW_COUNT# rows.  Please apply a filter to reduce the number of records in your query.'
,p_no_data_found_message=>'No data found.'
...
,p_detail_link=>'f?p=&APP_ID.:310:&SESSION.:MOD:&DEBUG.:310:P310_DOCNUMBR1,P310_DOCTDATE1,P310_DOCTTYPE,P310_SUBTTYPE,P310_ITEMCODE1,P310_WARECODE,P310_DOCDESC:#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#,#ITEMCODE#,#WARECODE#,&P309_NARATION.'
,p_detail_link_text=>'<img src="#IMAGE_PREFIX#menu/pencil16x16.gif" alt="" />'
,p_owner=>'RILADM'
,p_internal_uid=>225332277723927764
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43616695264372010)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43617053469372010)
,p_db_column_name=>'DOCDETAIL'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Document Details'
,p_column_link=>'f?p=&APP_ID.:310:&SESSION.::&DEBUG.::P310_DOCNUMBR1,P310_DOCTDATE1,P310_DOCTTYPE,P310_SUBTTYPE:#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#'
,p_column_type=>'STRING'
,p_display_text_as=>'WITHOUT_MODIFICATION'
,p_tz_dependent=>'N'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43617486872372012)
,p_db_column_name=>'CHECKBOX'
,p_display_order=>3
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43617868240372012)
,p_db_column_name=>'DOCNUMBR'
,p_display_order=>4
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43618287725372012)
,p_db_column_name=>'DOCTDATE'
,p_display_order=>5
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43618686474372012)
,p_db_column_name=>'ITEMCODE'
,p_display_order=>7
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43619029169372012)
,p_db_column_name=>'ITEMDESC'
,p_display_order=>8
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43619445411372012)
,p_db_column_name=>'STATUSCD'
,p_display_order=>9
,p_column_identifier=>'I'
,p_column_label=>'Statuscd'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43619870160372012)
,p_db_column_name=>'PRINT_COLUMN'
,p_display_order=>10
,p_column_identifier=>'J'
,p_column_label=>'Print'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43620315825372013)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43620711907372013)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43621064580372023)
...
'if v_add=''Y'' and :P309_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43621444234372026)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43614290010372004)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43614672342372007)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43615110653372009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43615440294372009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43615891958372009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43616304715372009)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(48339338836520563)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47038396650358104)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(192990188289527985)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'759682'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMDESC:DESIGNCD:REQUEST_QTY:APPROVE_QTY:RECEIVE_QTY:RAISEDBY:RAISEDFROM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(212605795395117067)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(212600194297079340)
,p_name=>'Requisition Type'
,p_parent_plug_id=>wwv_flow_api.id(212605795395117067)
,p_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43626025018372037)
,p_query_column_id=>1
,p_column_alias=>'D'
,p_column_display_sequence=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43626435038372038)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(43626824629372038)
,p_query_column_id=>3
,p_column_alias=>'R'
,p_column_display_sequence=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(212607637859126856)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(212632682771893097)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43627557633372038)
,p_button_sequence=>5
,p_button_plug_id=>wwv_flow_api.id(212607637859126856)
,p_button_name=>'P309_MOD'
,p_button_static_id=>'P89_MOD'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Mod'
,p_button_redirect_url=>'f?p=&APP_ID.:309:&SESSION.:MOD:&DEBUG.:::'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43628008586372040)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(212607637859126856)
,p_button_name=>'P309_DEL'
,p_button_static_id=>'P89_DEL'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Del'
,p_button_redirect_url=>'f?p=&APP_ID.:309:&SESSION.:DEL:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43628344015372041)
,p_button_sequence=>15
,p_button_plug_id=>wwv_flow_api.id(212607637859126856)
,p_button_name=>'P309_ENQ'
,p_button_static_id=>'P89_ENQ'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_id=>wwv_flow_api.id(47630389996858357)
,p_button_is_hot=>'Y'
,p_button_image_alt=>'Enq'
,p_button_redirect_url=>'f?p=&APP_ID.:309:&SESSION.:ENQ:&DEBUG.:::'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43603175049371959)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(144403714818480911)
,p_button_name=>'P309_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43622647288372030)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(192985804699526420)
,p_button_name=>'P309_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:310:&SESSION.:ADD:&DEBUG.::P310_DOCTTYPE,P310_SUBTTYPE,P310_DOCDESC,P310_S_PRDTYP,P310_S_PRSTYP:&P309_TRANTYPE.,&P309_SUBTTYPE.,&P309_NARATION.,&P309_PRDOCTYP.,&P309_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43622248457372029)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43623025987372030)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P309_DELDOCNUMBER. Really?'', ''DELETE'');'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(43603609843371968)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43597241442371890)
,p_name=>'P309_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(144402720675480910)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43597661948371912)
,p_name=>'P309_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(144402720675480910)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43598074066371912)
,p_name=>'P309_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(144402720675480910)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43603980585371973)
,p_name=>'P309_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43604350408371974)
,p_name=>'P309_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43604756153371974)
,p_name=>'P309_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43605119622371974)
,p_name=>'P309_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43605555098371974)
,p_name=>'P309_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43605937897371977)
,p_name=>'P309_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_use_cache_before_default=>'NO'
,p_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43606301222371979)
,p_name=>'P309_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43606716081371979)
,p_name=>'P309_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(144403714818480911)
,p_item_default=>'0'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43623484279372030)
,p_name=>'P309_POSTSTATUS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(192985804699526420)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43623835780372032)
,p_name=>'P309_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(192985804699526420)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43624278059372032)
,p_name=>'P309_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(192985804699526420)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43624629727372034)
,p_name=>'P309_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(192985804699526420)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43625065574372034)
,p_name=>'P309_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(192985804699526420)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43629044499372041)
,p_name=>'P309_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(212632682771893097)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43629428329372046)
,p_name=>'P309_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(212632682771893097)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(43629832998372048)
,p_name=>'P309_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(212632682771893097)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(43630330916372082)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(43630652132372087)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43632603797372101)
,p_name=>'set value on P309_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43633084496372107)
,p_event_id=>wwv_flow_api.id(43632603797372101)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P309_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43633426714372113)
,p_name=>'set value on P309_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43634015952372115)
,p_event_id=>wwv_flow_api.id(43633426714372113)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P309_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P309_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43634376407372115)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43634881992372116)
,p_event_id=>wwv_flow_api.id(43634376407372115)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P309_XURLTEST;',
'end;'))
,p_attribute_02=>'P309_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43635308636372116)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43635741217372116)
,p_event_id=>wwv_flow_api.id(43635308636372116)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43636175010372116)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43636620477372116)
,p_event_id=>wwv_flow_api.id(43636175010372116)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43637020610372116)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43637594693372118)
,p_event_id=>wwv_flow_api.id(43637020610372116)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(144408826419480946)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43637950937372121)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43638516394372121)
,p_event_id=>wwv_flow_api.id(43637950937372121)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P309_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P309_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.component_end;
end;
/
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(43638912492372122)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(43639330732372122)
,p_event_id=>wwv_flow_api.id(43638912492372122)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43631761221372099)
...
'',
'',
'If :P309_PROGNM  is null and :P309_NO is null then',
'   :P309_PROGNM := :FX_PROG_NAME;',
'   :P309_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P309_PROGNM,',
'                                      p_parentnm =>:P309_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P309_OPRSTAMP := :app_user;',
'  --:P309_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P309_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P309_PROGNM;',
'   :FX_PAGE_NO := :P309_NO;',
'Elsif :FX_PROG_NAME <> :P309_PROGNM And :FX_PAGE_NO <> :P309_NO Then',
'   :FX_PROG_NAME := :P309_PROGNM;',
'   :FX_PAGE_NO := :P309_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43630940630372088)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43632122917372099)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P309_DELDOCNUMBER);',
'begin',
'   for i in 1 .. l_deldoc.count',
'   loop',
'      delete from nmprocur  where docnumbr   = l_deldoc(i) ',
'      and COMPCODE=:COMPCODE ',
'      and DOCTTYPE=:P309_TRANTYPE ',
'      and SUBTTYPE=:P309_SUBTTYPE',
'      and POSTFLAG=:P309_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(43631410790372099)
