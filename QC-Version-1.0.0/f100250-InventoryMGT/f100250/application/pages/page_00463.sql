...
,p_last_upd_yyyymmddhh24miss=>'20201103153138'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(383312809958542145)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(383312994430542145)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(383312809958542145)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(383313194695542148)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(383312994430542145)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(431754375727164883)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(431896484579587658)
...
'         AND a.docttype = :p463_trantype',
'         AND a.subttype = :p463_subttype',
...
,p_ajax_items_to_submit=>'P463_POSTSTATUS,P463_TRANTYPE,P463_SUBTTYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(431896574534587658)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>431896574534587658
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74492273948764509)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74492621992764509)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74493040022764510)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74493469470764510)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74493851836764510)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74494280562764512)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74495008877764514)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74495465033764514)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74495862149764515)
...
'if v_add=''Y'' and :P463_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74496219153764517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74491877215764507)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74491489378764506)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74494628253764512)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74496613576764517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74497037909764517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74497471183764518)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74497847545764518)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74498254840764520)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74498606151764520)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(74489945563764504)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(431754375727164883)
,p_button_name=>'P463_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:88:&SESSION.:ADD:&DEBUG.::P88_DOCTTYPE,P88_SUBTTYPE,P88_DOCDESC,P88_S_PRDTYP,P88_S_PRSTYP:&P463_TRANTYPE.,&P463_SUBTTYPE.,&P463_NARATION.,&P463_PRDOCTYP.,&P463_PRSUBTYP.'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(74490335836764504)
...
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure to Delete the docnumber &P463_DELDOCNUMBER.?'', ''DELETE'');'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(74490702876764504)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74499471812764523)
,p_name=>'P463_POSTSTATUS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
,p_item_default=>'NEW'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74499846812764523)
,p_name=>'P463_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74500297443764523)
,p_name=>'P463_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74500616375764523)
,p_name=>'P463_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74501025364764525)
,p_name=>'P463_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74501490840764525)
,p_name=>'P463_RANDOMNO'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(431896484579587658)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74502157409764525)
,p_name=>'P463_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(451543362651954335)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74502515378764526)
,p_name=>'P463_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(451543362651954335)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(74502938984764526)
,p_name=>'P463_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(451543362651954335)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(74503497494764526)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(74503838888764528)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74506134354764529)
,p_name=>'set value on P463_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74506648087764531)
,p_event_id=>wwv_flow_api.id(74506134354764529)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P463_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74507018535764531)
,p_name=>'set value on P463_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74507503823764531)
,p_event_id=>wwv_flow_api.id(74507018535764531)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P463_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P463_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74507900341764531)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74508480094764532)
,p_event_id=>wwv_flow_api.id(74507900341764531)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74508802522764532)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74509399527764532)
,p_event_id=>wwv_flow_api.id(74508802522764532)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74509705526764532)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74510295514764532)
,p_event_id=>wwv_flow_api.id(74509705526764532)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74510600461764534)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74511002821764534)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74511535013764534)
,p_event_id=>wwv_flow_api.id(74511002821764534)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P463_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P463_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74511921280764534)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74512432259764535)
,p_event_id=>wwv_flow_api.id(74511921280764534)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74512858627764535)
,p_name=>'Close Dialog'
,p_event_sequence=>270
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(74490702876764504)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74513370086764535)
,p_event_id=>wwv_flow_api.id(74512858627764535)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(74513732442764535)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(74514290579764535)
,p_event_id=>wwv_flow_api.id(74513732442764535)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(74505370696764529)
...
'',
'',
'If :P463_PROGNM  is null and :P463_NO is null then',
'   :P463_PROGNM := :FX_PROG_NAME;',
'   :P463_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P463_PROGNM,',
'                                      p_parentnm =>:P463_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P463_OPRSTAMP := :app_user;',
'  --:P463_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P463_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P463_PROGNM;',
'   :FX_PAGE_NO := :P463_NO;',
'Elsif :FX_PROG_NAME <> :P463_PROGNM And :FX_PAGE_NO <> :P463_NO Then',
'   :FX_PROG_NAME := :P463_PROGNM;',
'   :FX_PAGE_NO := :P463_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(74504557775764528)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(74505764181764529)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P463_DELDOCNUMBER);',
'begin',
...
'         and COMPCODE = :COMPCODE ',
'         and DOCTTYPE = :P463_TRANTYPE ',
'         and SUBTTYPE = :P463_SUBTTYPE',
'         and POSTFLAG = :P463_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(74504951894764529)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(74504161086764528)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'New'
