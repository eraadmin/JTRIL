...
,p_page_mode=>'MODAL'
,p_step_title=>'Stock Receipt (Purchase)'
...
,p_last_upd_yyyymmddhh24miss=>'20200429163344'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(58113216874112216)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(168551935523376112)
...
'            AND docttype = :docttype --:P441_TRANTYPE',
'            AND subttype = :subttype --:P441_SUBTTYPE',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(168552280531376112)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>168552280531376112
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47581399402326667)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47581766889326668)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47582122531326675)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47582511847326678)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47582987973326682)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47583360706326682)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47583716399326684)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47584136633326687)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47584507974326687)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47584903193326687)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47585303441326687)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47585702134326692)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47578922365326656)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47579389753326657)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47579762531326659)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47580180874326660)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47580541205326664)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47580998119326667)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47576606329326637)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47576926840326645)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47577387443326646)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47577700452326648)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47578148753326653)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(47578545866326654)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(168557580223376116)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'475861'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMCODE:ITEMDESC:REQUEST_QTY:ISSUE_QTY:RECEIVE_QTY:RAISEDFROM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47586520920326701)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(58113216874112216)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47586967913326709)
,p_button_sequence=>120
,p_button_plug_id=>wwv_flow_api.id(168551935523376112)
...
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P441_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(47587376351326709)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:106:&SESSION.::&DEBUG.:106:P106_DOCTTYPE,P106_SUBTTYPE,P106_DOCDESC,P106_S_PRDTYP,P106_S_PRSTYP:&P441_TRANTYPE.,&P441_SUBTTYPE.,&P441_NARATION.,&P441_PRDOCTYP.,&P441_PRSUBTYP.'
,p_required_patch=>wwv_flow_api.id(981178456698168123)
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47587793672326710)
,p_name=>'P441_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47588119940326725)
,p_name=>'P441_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47588577007326725)
,p_name=>'P441_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47588996945326725)
,p_name=>'P441_PRDOCTYP'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47589364422326726)
,p_name=>'P441_PRSUBTYP'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
,p_item_default=>wwv_flow_string.join(wwv_flow_t_varchar2(
'SELECT prsubtyp',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47589706561326726)
,p_name=>'P441_NARATION'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47590122557326726)
,p_name=>'P441_REQUEST'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(47590521469326728)
,p_name=>'P441_DELDOCNUMBER'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(168551935523376112)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47591075857326728)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(47591414003326731)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47593699703326740)
,p_name=>'set value on P441_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47594198854326742)
,p_event_id=>wwv_flow_api.id(47593699703326740)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P441_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47594523371326745)
,p_name=>'set value on P441_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47595024843326746)
,p_event_id=>wwv_flow_api.id(47594523371326745)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P441_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P441_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47595425075326746)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47595957635326746)
,p_event_id=>wwv_flow_api.id(47595425075326746)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P441_XURLTEST;',
'end;'))
,p_attribute_02=>'P441_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47599088347326748)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47599521005326750)
,p_event_id=>wwv_flow_api.id(47599088347326748)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47596325397326746)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47596832309326748)
,p_event_id=>wwv_flow_api.id(47596325397326746)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47597272469326748)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47597709382326748)
,p_event_id=>wwv_flow_api.id(47597272469326748)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P441_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmmrstrn input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P441_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47598146745326748)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47598646858326748)
,p_event_id=>wwv_flow_api.id(47598146745326748)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(47599981242326750)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(47600476523326750)
,p_event_id=>wwv_flow_api.id(47599981242326750)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47592825909326735)
...
'',
'',
'If :P441_PROGNM  is null and :P441_NO is null then',
'   :P441_PROGNM := :FX_PROG_NAME;',
'   :P441_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P441_PROGNM,',
'                                      p_parentnm =>:P441_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P441_OPRSTAMP := :app_user;',
'  --:P441_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P441_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P441_PROGNM;',
'   :FX_PAGE_NO := :P441_NO;',
'Elsif :FX_PROG_NAME <> :P441_PROGNM And :FX_PAGE_NO <> :P441_NO Then',
'   :FX_PROG_NAME := :P441_PROGNM;',
'   :FX_PAGE_NO := :P441_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47593261173326735)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47592440809326735)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P441_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47591701988326731)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(47586520920326701)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(47592024349326734)
