...
,p_last_upd_yyyymmddhh24miss=>'20200615173045'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384490915545621195)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384491100017621195)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(384490915545621195)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(384491300282621198)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(384491100017621195)
,p_region_template_options=>'#DEFAULT#:t-Region--hiddenOverflow'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47588528672858186)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(432932481314243933)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(433074590166666708)
...
'         AND a.docttype = :p471_trantype',
'         AND a.subttype = :p471_subttype',
'         AND (a.costcode IN',
'                 (SELECT cabasecc',
'                    FROM sycstacc',
...
,p_ajax_items_to_submit=>'P471_TRANTYPE,P471_SUBTTYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_query_show_nulls_as=>' - '
,p_pagination_display_position=>'BOTTOM_RIGHT'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(433074680121666708)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>433074680121666708
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75670480025843557)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75670800333843559)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75671263182843559)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75671661426843559)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75672012780843560)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75672478848843560)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75673285635843562)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75673617382843564)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75674096643843564)
...
'if v_add=''Y'' and :P471_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75674416394843564)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75670057866843557)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75669658092843557)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75672807510843562)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75676013193843567)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(75676477842843567)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74430172648573809)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74430246727573810)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74430338876573811)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74430488344573812)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74430573383573813)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(433078973756668273)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'756772'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(452721468239033385)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(75668193964843554)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(432932481314243933)
,p_button_name=>'P471_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:88:&SESSION.:ADD:&DEBUG.::P88_DOCTTYPE,P88_SUBTTYPE,P88_DOCDESC,P88_S_PRDTYP,P88_S_PRSTYP:&P471_TRANTYPE.,&P471_SUBTTYPE.,&P471_NARATION.,&P471_PRDOCTYP.,&P471_PRSUBTYP.'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(75668563991843556)
...
,p_button_position=>'BELOW_BOX'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure to Delete the docnumber &P471_DELDOCNUMBER.?'', ''DELETE'');'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(75668992846843556)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75677674432843568)
,p_name=>'P471_POSTSTATUS'
,p_is_required=>true
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
,p_item_default=>'NEW'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75678073476843570)
,p_name=>'P471_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75678420530843570)
,p_name=>'P471_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75678841597843571)
,p_name=>'P471_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75679235529843571)
,p_name=>'P471_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75679603784843571)
,p_name=>'P471_RANDOMNO'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(433074590166666708)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75680398227843573)
,p_name=>'P471_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(452721468239033385)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
,p_attribute_01=>'N'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75680783867843573)
,p_name=>'P471_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(452721468239033385)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(75681122647843575)
,p_name=>'P471_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(452721468239033385)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(75681674703843575)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(75682015131843575)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(75684335313843578)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(75684815062843579)
,p_event_id=>wwv_flow_api.id(75684335313843578)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P471_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P471_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(75685203796843579)
,p_name=>'Close Dialog'
,p_event_sequence=>270
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_api.id(75668992846843556)
,p_bind_type=>'bind'
,p_bind_event_type=>'click'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(75685718704843579)
,p_event_id=>wwv_flow_api.id(75685203796843579)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(75686172361843581)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(75686616716843581)
,p_event_id=>wwv_flow_api.id(75686172361843581)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(75683564962843578)
...
'',
'',
'If :P471_PROGNM  is null and :P471_NO is null then',
'   :P471_PROGNM := :FX_PROG_NAME;',
'   :P471_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P471_PROGNM,',
'                                      p_parentnm =>:P471_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P471_OPRSTAMP := :app_user;',
'  --:P471_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P471_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P471_PROGNM;',
'   :FX_PAGE_NO := :P471_NO;',
'Elsif :FX_PROG_NAME <> :P471_PROGNM And :FX_PAGE_NO <> :P471_NO Then',
'   :FX_PROG_NAME := :P471_PROGNM;',
'   :FX_PAGE_NO := :P471_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(75682741285843576)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(75683951328843578)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P471_DELDOCNUMBER);',
'begin',
...
'         and COMPCODE = :COMPCODE ',
'         and DOCTTYPE = :P471_TRANTYPE ',
'         and SUBTTYPE = :P471_SUBTTYPE',
'         and POSTFLAG = :P471_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(75683150758843578)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(75682356355843576)
,p_process_sequence=>20
,p_process_point=>'BEFORE_HEADER'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'New'
