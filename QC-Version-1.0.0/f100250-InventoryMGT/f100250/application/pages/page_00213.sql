...
,p_last_upd_yyyymmddhh24miss=>'20170919155108'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(126419188626957392)
,p_plug_name=>'No of Leads'
...
'    or g.SMANCODE in (select P.smancode',
'                         from VW_SMAN_PRODUCT P ',
'                        where g.smancode like P.SMANCODE_TREE||''%''',
'                         and p.REPORTNG = :APP_USER',
'                         and to_date(g.DOCTDATE,''dd-mon-yyyy'') between to_date(P.STARTDATE,''dd-mon-yyyy'') ',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(126419604219957395)
,p_name=>'Customers'
...
,p_owner=>'MIKE'
,p_internal_uid=>89264737094276901
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37096450715026517)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097192974026524)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097280839026525)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097316389026526)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37096718314026520)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37096689717026519)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37096851798026521)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37096899702026522)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097026239026523)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097430470026527)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37097507365026528)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(37846248197091912)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(126424827342957412)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'892700'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>30
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(126431911276966933)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(126425284328957414)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(126419188626957392)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(126425692695957417)
...
,p_button_redirect_url=>'f?p=&APP_ID.:213:&SESSION.::&DEBUG.:RP,1,RIR,CIR::'
,p_button_condition_type=>'NEVER'
,p_grid_new_row=>'N'
,p_grid_new_column=>'N'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(126426157816957417)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(126428714756957434)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(126426618861957420)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(126427761743957426)
,p_name=>'Select Advanced'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_api.id(126419188626957392)
,p_bind_type=>'bind'
,p_bind_event_type=>'apexafterrefresh'
);
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(126428250838957431)
,p_event_id=>wwv_flow_api.id(126427761743957426)
,p_event_result=>'TRUE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(126426897789957425)
...
,p_process_when=>'Go,P213_REPORT_SEARCH,RESET'
,p_process_when_type=>'REQUEST_IN_CONDITION'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(126427285533957426)
