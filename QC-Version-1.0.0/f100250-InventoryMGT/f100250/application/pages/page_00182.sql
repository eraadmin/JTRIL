...
,p_last_upd_yyyymmddhh24miss=>'20180206124744'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120238259948017559)
,p_plug_name=>' '
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120238481272017598)
,p_plug_name=>'docnumer show'
,p_parent_plug_id=>wwv_flow_api.id(120238259948017559)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47571367397858173)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120238767644017599)
,p_plug_name=>'Program name show'
,p_parent_plug_id=>wwv_flow_api.id(120238481272017598)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-Report--altRowsDefault:t-Report--rowHighlight'
,p_plug_template=>wwv_flow_api.id(47571367397858173)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120239180764017599)
...
'            AND docttype = :P182_TRANTYPE',
'            AND subttype = :P182_SUBTTYPE',
'            AND (costcode IN (SELECT cabasecc',
'                                FROM sycstacc',
'                               WHERE compcode = :compcode  AND grupcode = :APP_USER))',
'                                group by s.COMPCODE,s.RAISEDBY,s.postflag, s.WARECODE,s.DOCTTYPE, s.SUBTTYPE, s.DOCNUMBR, s.DOCTDATE,s.statuscd',
'  -- group by COMPCODE, DOCTTYPE, SUBTTYPE, DOCNUMBR, DOCTDATE,statuscd',
'       ORDER BY doctdate DESC--, docnumbr DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P182_TRANTYPE,P182_SUBTTYPE,P182_POSTSTATUS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(120239637726017604)
,p_name=>'Report 1'
...
,p_detail_link=>'f?p=&APP_ID.:183:&SESSION.::&DEBUG.::P183_DOCNUMBR,P183_DOCTTYPE,P183_SUBTTYPE,P183_DOCTDATE,P183_PODCNO,P183_S_PRDTYP,P183_S_PRSTYP,P183_SUPPLIERCDE,P183_COSTCODE,P183_WARECODE:#DOCNUMBR#,#DOCTTYPE#,#SUBTTYPE#,#DOCTDATE#,#UPDOCNUM#,#UPDOCTYP#,#UPSUB'
...
,p_owner=>'RILADM'
,p_internal_uid=>83084770600337110
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120241315346017618)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120241732223017618)
,p_db_column_name=>'ID'
,p_display_order=>10
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120242128395017618)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120242489938017618)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120242876078017619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120243751292017619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120244128575017619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120244479255017619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120245316211017619)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120239747206017615)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120240114405017616)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(120240468241017616)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786193017693069)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786285115693070)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786342753693071)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786462261693072)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786599107693073)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(43786670163693074)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(120245742097017619)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'830909'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120252648910017660)
...
||'- &P182_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P182_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(120254240846017662)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120257358269017676)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120257694385017677)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120258070278017677)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120258551123017677)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120258912351017677)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120259307763017677)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120254611106017666)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120255058736017674)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120255318152017676)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120255747135017676)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120256104466017676)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120256475393017676)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120256925819017676)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(120259759937017677)
,p_name=>'Reports'
,p_region_name=>'IR'
,p_template=>wwv_flow_api.id(47587389655858184)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120260155620017679)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(120260507678017679)
,p_query_column_id=>2
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(120260907537017679)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(137192776006753692)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120247057383017646)
,p_button_sequence=>100
,p_button_plug_id=>wwv_flow_api.id(120239180764017599)
,p_button_name=>'P182_REPORTNAME'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120246226385017624)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120261331950017679)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120261667527017679)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P182_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(137257264348777397)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:183:&SESSION.::&DEBUG.:183:P183_DOCTTYPE,P183_SUBTTYPE,P183_DOCDESC,P183_S_PRDTYP,P183_S_PRSTYP:&P182_TRANTYPE.,&P182_SUBTTYPE.,&P182_NARATION.,&P182_PRDOCTYP.,&P182_PRSUBTYP.'
,p_button_condition=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare',
'v_add varchar2(5);',
'begin',
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(120246660810017643)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120247412149017648)
,p_name=>'P182_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_item_default=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120247815698017657)
,p_name=>'P182_ITEMCODE'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_prompt=>'Itemcode'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120248239383017657)
,p_name=>'P182_DOCNUMBER'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120248643120017657)
,p_name=>'P182_PROGNAME'
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120249034088017657)
,p_name=>'P182_XURLTEST'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_prompt=>'Xurltest'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120249466680017657)
,p_name=>'P182_XURL'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_prompt=>'Xurl'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120249844436017657)
,p_name=>'P182_DELVERDOCNUM'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120250191842017658)
,p_name=>'P182_GATPASSDOCNUM'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120250662000017658)
,p_name=>'P182_S_H_REGION'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_item_default=>'0'
,p_prompt=>'S H Region'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120250978493017658)
,p_name=>'P182_REQUEST'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120251382234017658)
,p_name=>'P182_TRANTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_prompt=>'Trantype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120251798586017658)
,p_name=>'P182_SUBTTYPE'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
,p_prompt=>'Subttype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120252227234017658)
,p_name=>'P182_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(120239180764017599)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120253001874017660)
,p_name=>'P182_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(120252648910017660)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120253386121017662)
,p_name=>'P182_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(120252648910017660)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(120253811923017662)
,p_name=>'P182_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(120252648910017660)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137193083835753692)
,p_name=>'P182_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(137192776006753692)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137193554044753694)
,p_name=>'P182_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(137192776006753692)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(137193934218753694)
,p_name=>'P182_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(137192776006753692)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(120262248743017690)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(120262613129017705)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120269876282017751)
,p_name=>'set value on P182_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120270464155017751)
,p_event_id=>wwv_flow_api.id(120269876282017751)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P182_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120264537788017722)
,p_name=>'set value on P182_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120264999536017727)
,p_event_id=>wwv_flow_api.id(120264537788017722)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P182_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P182_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120265462119017735)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120265920532017735)
,p_event_id=>wwv_flow_api.id(120265462119017735)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P182_XURLTEST;',
'end;'))
,p_attribute_02=>'P182_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120266298604017736)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120266801631017736)
,p_event_id=>wwv_flow_api.id(120266298604017736)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120267254807017736)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120267705009017736)
,p_event_id=>wwv_flow_api.id(120267254807017736)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120268096675017741)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120268645837017744)
,p_event_id=>wwv_flow_api.id(120268096675017741)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_api.id(120259759937017677)
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(120269065888017749)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(120269471830017751)
,p_event_id=>wwv_flow_api.id(120269065888017749)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P182_DELVERDOCNUM'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmstkrcp input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P182_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120264159910017721)
...
'',
'',
'If :P182_PROGNM  is null and :P182_NO is null then',
'   :P182_PROGNM := :FX_PROG_NAME;',
'   :P182_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P182_PROGNM,',
'                                      p_parentnm =>:P182_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P182_OPRSTAMP := :app_user;',
'  --:P182_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P182_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P182_PROGNM;',
'   :FX_PAGE_NO := :P182_NO;',
'Elsif :FX_PROG_NAME <> :P182_PROGNM And :FX_PAGE_NO <> :P182_NO Then',
'   :FX_PROG_NAME := :P182_PROGNM;',
'   :FX_PAGE_NO := :P182_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120262940033017707)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120263736655017721)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P182_DELDOCNUMBER);',
'begin',
'',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(120263353130017719)
