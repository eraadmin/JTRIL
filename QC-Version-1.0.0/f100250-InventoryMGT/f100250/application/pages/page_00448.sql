...
,p_name=>'Campaign Material Requisition'
,p_page_mode=>'MODAL'
,p_step_title=>'Campaign Material Requisition'
...
,p_last_upd_yyyymmddhh24miss=>'20201103152152'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(183942710484918250)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(183962840832918320)
,p_plug_name=>'Campaign Material Requisition'
...
'         nvl(SUM (a.apprqnty),0) approve_qty,',
'         nvl(SUM (a.trnsqnty),0) Transaction_qty,',
'         nvl(SUM (a.RETRNQTY),0) Transfer_qty,',
...
'            raisedfrom,',
'            INITCAP ( (SELECT distinct costcode || '' : '' || INITCAP (costdesc)',
'                      FROM syjobmas_sub',
'                     WHERE costcode = a.sub_costcode AND compcode = a.compcode and parentwcode=a.warecode))',
'            Showroom,',
'         null post_status,',
'         a.batchnum,',
...
'            print_column',
'    FROM nmstkmov a, nmreqapr q',
'   WHERE     a.compcode = :compcode',
'         AND a.compcode = q.compcode(+)',
'         AND a.itemcode = q.itemcode(+)',
'         AND a.docnumbr = q.docnumbr(+)',
'         AND a.docttype = q.docttype(+)',
'         AND a.subttype = q.subttype(+)',
'         AND a.warecode = q.warecode(+)',
'         AND a.batchnum = q.batchnum(+)',
'         AND a.docttype = :p448_trantype',
'         AND a.subttype = :p448_subttype',
...
,p_ajax_items_to_submit=>'P448_POSTSTATUS,P448_TRANTYPE,P448_SUBTTYPE'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(183963238033918320)
,p_name=>'test'
...
,p_detail_link=>'f?p=&APP_ID.:86:&SESSION.:MOD:&DEBUG.::P86_DOCNUMBR,P86_DOCNUMBR1,P86_DOCTDATE,P86_DOCTTYPE,P86_SUBTTYPE,P86_DOCDESC,P86_COSTCODE,P86_SOURCEWARECODE,P86_WARECODE,P86_SRCCOSTCD:#DOCNUMBR#,#DOCNUMBR#,#DOCTDATE#,#DOCTTYPE#,#SUBTTYPE#,&P87_NARATION.,#COS'
||'TCODE#,#SRCWRECD#,#WARECODE#,#SRCWRECD##SNDPERSN#,#SRCWRECD#'
...
,p_owner=>'RILADM'
,p_internal_uid=>183963238033918320
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63120599574344201)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63120916197344201)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63121378585344203)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63121776267344203)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63122162074344203)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63122516651344204)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63122901644344206)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63123311203344206)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63123737814344207)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63124159582344207)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63124543249344209)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63124946628344210)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63125310347344210)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63117312899344193)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63117787415344195)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63118184132344196)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(63119770889344200)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57228893906786008)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57228923910786009)
,p_db_column_name=>'TRANSACTION_QTY'
,p_display_order=>104
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57229071105786010)
,p_db_column_name=>'TRANSFER_QTY'
,p_display_order=>114
,p_column_identifier=>'Y'
,p_column_label=>'Transfer Qty'
,p_column_type=>'NUMBER'
,p_column_alignment=>'RIGHT'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57229148321786011)
,p_db_column_name=>'SHOWROOM'
,p_display_order=>124
,p_column_identifier=>'Z'
,p_column_label=>'Showroom'
,p_column_type=>'STRING'
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57229251305786012)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(57229318517786013)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(183968489933918323)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'631257'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCDETAIL:DOCTDATE:ITEMDESC:REQUEST_QTY:APPROVE_QTY:TRANSACTION_QTY:TRANSFER_QTY:BATCHNUM:RAISEDFROM:SHOWROOM:PRINT_COLUMN:'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(63126178987344212)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(183962840832918320)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(63126555105344212)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'f?p=&APP_ID.:86:&SESSION.::&DEBUG.:86:P86_DOCTTYPE,P86_SUBTTYPE,P86_DOCDESC,P86_S_PRDTYP,P86_S_PRSTYP:&P448_TRANTYPE.,&P448_SUBTTYPE.,&P448_NARATION.,&P448_PRDOCTYP.,&P448_PRSUBTYP.'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(63126910729344214)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P448_DELDOCNUMBER. Really?'', ''DELETE'');'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63127304227344214)
,p_name=>'P448_POSTSTATUS'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
,p_item_default=>'NEW'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63127721071344214)
,p_name=>'P448_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63128157744344215)
,p_name=>'P448_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63128569500344215)
,p_name=>'P448_PRDOCTYP'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63128929012344215)
,p_name=>'P448_PRSUBTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63129393751344215)
,p_name=>'P448_REQUEST'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63129706151344217)
,p_name=>'P448_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(63130162716344217)
,p_name=>'P448_DELDOCNUMBER'
,p_item_sequence=>170
,p_item_plug_id=>wwv_flow_api.id(183962840832918320)
,p_display_as=>'NATIVE_HIDDEN'
,p_encrypt_session_state_yn=>'N'
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(63130622747344217)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(63131027906344218)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63133369291344221)
,p_name=>'set value on P448_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63133808824344221)
,p_event_id=>wwv_flow_api.id(63133369291344221)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P448_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63134215103344221)
,p_name=>'set value on P448_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63134707007344223)
,p_event_id=>wwv_flow_api.id(63134215103344221)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P448_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P448_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63135187273344223)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63135616854344223)
,p_event_id=>wwv_flow_api.id(63135187273344223)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
'begin',
':XURLTEST:=:P448_XURLTEST;',
'end;'))
,p_attribute_02=>'P448_XURLTEST'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63136025834344223)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63136533208344223)
,p_event_id=>wwv_flow_api.id(63136025834344223)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63136900827344225)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63137448043344225)
,p_event_id=>wwv_flow_api.id(63136900827344225)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63137895461344225)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63138325750344225)
,p_event_id=>wwv_flow_api.id(63137895461344225)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P448_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmissreq input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P448_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63138759890344226)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63139248034344226)
,p_event_id=>wwv_flow_api.id(63138759890344226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(63139630498344226)
,p_name=>'closeX'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(63140151553344226)
,p_event_id=>wwv_flow_api.id(63139630498344226)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(63131761286344218)
...
'',
'',
'If :P448_PROGNM  is null and :P448_NO is null then',
'   :P448_PROGNM := :FX_PROG_NAME;',
'   :P448_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P448_PROGNM,',
'                                      p_parentnm =>:P448_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P448_OPRSTAMP := :app_user;',
'  --:P448_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P448_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P448_PROGNM;',
'   :FX_PAGE_NO := :P448_NO;',
'Elsif :FX_PROG_NAME <> :P448_PROGNM And :FX_PAGE_NO <> :P448_NO Then',
'   :FX_PROG_NAME := :P448_PROGNM;',
'   :FX_PAGE_NO := :P448_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(63132193506344218)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(63132916112344220)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P448_DELDOCNUMBER);',
'begin',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(63131304719344218)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_CLOSE_WINDOW'
,p_process_name=>'Close Dialog'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(63126178987344212)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(63132507193344220)
