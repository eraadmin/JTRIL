prompt --application/pages/page_01513
begin
--   Manifest
--     PAGE: 01513
--   Manifest End
...
,p_last_upd_yyyymmddhh24miss=>'20170411124001'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(97941713220582617)
...
||'- &P1513_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P1513_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(97946301340582651)
,p_name=>'sdsaddsad'
,p_region_name=>'MON'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66647788018555372)
,p_query_column_id=>1
,p_column_alias=>'ID'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66648142871555378)
,p_query_column_id=>2
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66648539813555378)
,p_query_column_id=>3
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66648900334555378)
,p_query_column_id=>4
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66649313504555378)
,p_query_column_id=>5
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66649764469555380)
,p_query_column_id=>6
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66650119821555380)
,p_query_column_id=>7
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66650499902555380)
,p_query_column_id=>8
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66650910616555381)
,p_query_column_id=>9
,p_column_alias=>'RATE'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66651272253555381)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66651728824555381)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66652159334555381)
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(66652473690555381)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(146382688392205352)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(146524797244628127)
...
'Select  M.DOCNUMBR,M.DOCTDATE,M.SLSOFERNO,M.FGITEMNM,M.PRTYNAME,Sum(M.Amount) TotalCst,',
...
'From (',
'Select  Distinct A.DOCNUMBR,A.DOCTDATE,A.FG_ITEMCODE,A.SLSOFRNO_FK,B.DOCNUMBR SLSOFERNO,',
'           (Select Itemdes1 From Nmitemas Where Compcode=:Compcode And Itemcode=A.FG_ITEMCODE) FGITEMNM,',
'           B.PARTYCDE,(Select  PRTYNAME From sycompty Where Compcode=:Compcode And PARTYCDE=B.PARTYCDE) PRTYNAME,A.BOM_NO,',
'          NVL(C.QTY,0)*NVL(C.ITEMRATE,0) Amount',
...
') M',
'Group By M.DOCNUMBR,M.DOCTDATE,M.SLSOFERNO,M.FGITEMNM,M.PRTYNAME',
'Order By M.DOCTDATE Desc,M.DOCNUMBR'))
,p_plug_source_type=>'NATIVE_IR'
,p_ajax_items_to_submit=>'P1513_TRANTYPE,P1513_SUBTTYPE'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(146524887199628127)
,p_name=>'test'
...
,p_owner=>'RILADM'
,p_internal_uid=>109370020073947633
);
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66656207437555386)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66656655272555386)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66355168972304606)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66355491530304609)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66355366140304607)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66355650477304610)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(66355714323304611)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(146529180834629692)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'295053'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_report_columns=>'DOCNUMBR:DOCTDATE::SLSOFERNO:FGITEMNM:PRTYNAME:TOTALCST:PRINT_COLUMN'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(166171675316994804)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66654344615555383)
,p_button_sequence=>110
,p_button_plug_id=>wwv_flow_api.id(146382688392205352)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66660572918555389)
,p_button_sequence=>1
,p_button_plug_id=>wwv_flow_api.id(146524797244628127)
,p_button_name=>'P1513_ADD'
...
,p_button_redirect_url=>'f?p=&APP_ID.:1510:&SESSION.:ADD:&DEBUG.::P88_DOCTTYPE,P88_SUBTTYPE,P88_DOCDESC,P88_S_PRDTYP,P88_S_PRSTYP:&P1513_TRANTYPE.,&P1513_SUBTTYPE.,&P1513_NARATION.,&P1513_PRDOCTYP.,&P1513_PRSUBTYP.'
,p_security_scheme=>wwv_flow_api.id(60507628718248520)
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(66661008245555389)
...
,p_button_position=>'RIGHT_OF_IR_SEARCH_BAR'
,p_button_redirect_url=>'javascript:apex.confirm(''Are you sure Delete the docnumber &P1513_DELDOCNUMBER. Really?'', ''DELETE'');'
...
'if v_add=''Y'' and :P1513_POSTSTATUS=''N'' then',
'return true;',
'else',
'return false;',
'end if;',
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66637664638555356)
,p_name=>'P1513_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(97941713220582617)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66638032677555358)
,p_name=>'P1513_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(97941713220582617)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66638454182555358)
,p_name=>'P1513_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(97941713220582617)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66661775259555389)
,p_name=>'P1513_TRANTYPE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(146524797244628127)
,p_prompt=>'Trantype'
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66662206556555389)
,p_name=>'P1513_SUBTTYPE'
,p_item_sequence=>110
,p_item_plug_id=>wwv_flow_api.id(146524797244628127)
,p_prompt=>'Subttype'
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66662637572555389)
,p_name=>'P1513_REQUEST'
,p_item_sequence=>120
,p_item_plug_id=>wwv_flow_api.id(146524797244628127)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66663050463555389)
,p_name=>'P1513_DELDOCNUMBER'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(146524797244628127)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66667057623555392)
,p_name=>'P1513_PRDOCTYP'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(166171675316994804)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cHeight=>1
,p_lov_display_extra=>'YES'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66667420343555392)
,p_name=>'P1513_PRSUBTYP'
,p_item_sequence=>150
,p_item_plug_id=>wwv_flow_api.id(166171675316994804)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(66667770450555392)
,p_name=>'P1513_NARATION'
,p_item_sequence=>160
,p_item_plug_id=>wwv_flow_api.id(166171675316994804)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(66668361160555394)
...
wwv_flow_api.create_page_computation(
 p_id=>wwv_flow_api.id(66668706977555397)
,p_computation_sequence=>10
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66670666074555403)
,p_name=>'set value on P1513_XURL'
,p_event_sequence=>9
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66671081762555405)
,p_event_id=>wwv_flow_api.id(66670666074555403)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'Y'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1513_XURL'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66671552658555405)
,p_name=>'set value on P1513_XURLTEST'
,p_event_sequence=>19
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
,p_bind_type=>'bind'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66672022154555406)
,p_event_id=>wwv_flow_api.id(66671552658555405)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_SET_VALUE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1513_XURLTEST'
...
'   END IF;',
'END;'))
,p_attribute_07=>'P1513_XURL'
,p_attribute_08=>'N'
,p_attribute_09=>'N'
,p_wait_for_result=>'Y'
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66672422492555408)
,p_name=>'assign url'
,p_event_sequence=>29
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66672912811555408)
,p_event_id=>wwv_flow_api.id(66672422492555408)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66673297668555408)
,p_name=>'call modal'
,p_event_sequence=>59
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'.highlight-row'
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66673859430555408)
,p_event_id=>wwv_flow_api.id(66673297668555408)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66674207817555408)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66674689777555408)
,p_event_id=>wwv_flow_api.id(66674207817555408)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66675117028555408)
...
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66675985112555408)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66676493645555409)
,p_event_id=>wwv_flow_api.id(66675985112555408)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_affected_elements_type=>'ITEM'
,p_affected_elements=>'P1513_DELDOCNUMBER'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var deldoc=  $(''#nmprocur input[name="f11"]:checked'').map(function(){',
'                  return $(this).val()',
'              }).get().join('':'')',
'',
'$(''#P1513_DELDOCNUMBER'').val(deldoc)'))
);
wwv_flow_api.create_page_da_event(
 p_id=>wwv_flow_api.id(66676956967555409)
...
wwv_flow_api.create_page_da_action(
 p_id=>wwv_flow_api.id(66677443988555409)
,p_event_id=>wwv_flow_api.id(66676956967555409)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_EXECUTE_PLSQL_CODE'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66669786688555402)
...
'',
'',
'If :P1513_PROGNM  is null and :P1513_NO is null then',
'   :P1513_PROGNM := :FX_PROG_NAME;',
'   :P1513_NO := :FX_PAGE_NO;',
'End if;',
'',
...
'                                      p_app_user =>:app_user,',
'                                      p_progname =>:P1513_PROGNM,',
'                                      p_parentnm =>:P1513_PARENT,',
'                                      p_add_allowed =>:FX_ADD_ALLOWED,',
'                                      p_mod_allowed =>:FX_MOD_ALLOWED,',
'                                      p_del_allowed =>:FX_DEL_ALLOWED,',
'                                      p_enq_allowed =>:FX_ENQ_ALLOWED',
'                                     );',
'  --:P1513_OPRSTAMP := :app_user;',
'  --:P1513_TIMSTAMP := SYSDATE;',
'--apex_application.g_print_success_message := :FX_PROG_NAME||'' - ''||:P1513_PROGNM;',
'',
'If :FX_PROG_NAME  is null and :FX_PAGE_NO is null then',
'   :FX_PROG_NAME := :P1513_PROGNM;',
'   :FX_PAGE_NO := :P1513_NO;',
'Elsif :FX_PROG_NAME <> :P1513_PROGNM And :FX_PAGE_NO <> :P1513_NO Then',
'   :FX_PROG_NAME := :P1513_PROGNM;',
'   :FX_PAGE_NO := :P1513_NO;',
'End if;'))
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66668984786555397)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66670218598555403)
,p_process_sequence=>30
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_PLSQL'
...
,p_process_sql_clob=>wwv_flow_string.join(wwv_flow_t_varchar2(
'declare ',
'  l_deldoc  apex_application_global.vc_arr2 := apex_util.string_to_table(:P1513_DELDOCNUMBER);',
'begin',
'   for i in 1 .. l_deldoc.count',
'   loop',
'      delete from nmprocur  where docnumbr   = l_deldoc(i) ',
'      and COMPCODE=:COMPCODE ',
'      and DOCTTYPE=:P1513_TRANTYPE ',
'      and SUBTTYPE=:P1513_SUBTTYPE',
'      and POSTFLAG=:P1513_POSTSTATUS;',
'   end loop;',
'  ',
'end;'))
,p_process_clob_language=>'PLSQL'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(66669457121555402)
