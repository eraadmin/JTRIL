...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68856884978496218)
,p_plug_name=>'COMPANY'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68857088787497304)
...
||'- &P95_PROGNM.&nbsp;&nbsp;&nbsp; Page No:- &P95_NO.&nbsp;&nbsp;&nbsp; Add:- &FX_ADD_ALLOWED.&nbsp;&nbsp;Mod:- &FX_MOD_ALLOWED.&nbsp;&nbsp;Del:- &FX_DEL_ALLOWED.&nbsp;&nbsp;Enq:- &FX_ENQ_ALLOWED.</font>'
,p_plug_display_condition_type=>'NEVER'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
,p_attribute_03=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68857488787497304)
,p_plug_name=>'Page Information'
,p_region_template_options=>'#DEFAULT#:is-expanded:t-Region--scrollBody'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(47580605777858182)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68857280650497304)
,p_name=>'P95_PROGNM'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(68857088787497304)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68857697590497307)
,p_name=>'P95_PARENT'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(68857088787497304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68857870251497307)
,p_name=>'P95_NO'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(68857088787497304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68858080650497307)
,p_name=>'P95_PROGNM_1'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(68857488787497304)
,p_display_as=>'NATIVE_HIDDEN'
,p_cSize=>30
,p_cMaxlength=>4000
,p_cAttributes=>'nowrap="nowrap"'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68858297590497307)
,p_name=>'P95_PARENT_1'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(68857488787497304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68858470251497307)
,p_name=>'P95_NO_1'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(68857488787497304)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(68856681861495341)
